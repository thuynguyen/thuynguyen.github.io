function changeBrightNess(){$(".filter-brightness-setting input[type=range]").on("change",_.throttle(bright,300))}function bright(){console.log("vao bright");var brightVal=$(this).val();Caman(".lower-canvas","./demo/images/sample_doodle.jpg",function(){this.revert(!1),this.brightness(parseInt(brightVal)).render()})}function changeSaturation(){console.log("vao saturation"),$(".filter-saturation-setting input[type=range]").change(function(){var satuVal=$(this).val();Caman(".lower-canvas","./demo/images/sample_doodle.jpg",function(){this.revert(!0),this.saturation(parseInt(satuVal)).render()})})}function changeRed(){console.log("vao red"),$(".filter-red-setting input[type=range]").change(function(){var self=this,redVal=$(self).val();Caman(".lower-canvas","./demo/images/sample_doodle.jpg",function(){this.revert(!1),this.channels({red:parseInt(redVal)}).render()})})}function changeGreen(){$(".filter-green-setting input[type=range]").change(function(){var self=this,greenVal=$(self).val();Caman(".lower-canvas","./demo/images/sample_doodle.jpg",function(){this.revert(!1),this.channels({green:parseInt(greenVal)}).render()})})}function changeBlue(){$(".filter-blue-setting input[type=range]").change(function(){alert("ok");var self=this,blueVal=$(self).val();Caman(".lower-canvas","./demo/images/sample_doodle.jpg",function(){this.revert(!1),this.channels({blue:parseInt(blueVal)}).render()})})}function resetFilter(){$("input[type=range]").each(function(){$(this).val(0)}),$("span.filter-value").html("0")}(function(){var $,Analyze,Blender,Calculate,Caman,CamanParser,Canvas,Convert,Event,Fiber,Filter,IO,Image,Layer,Log,Logger,PixelInfo,Plugin,Renderer,Root,Store,Util,fs,slice,__hasProp={}.hasOwnProperty,__indexOf=[].indexOf||function(item){for(var i=0,l=this.length;l>i;i++)if(i in this&&this[i]===item)return i;return-1},__slice=[].slice;slice=Array.prototype.slice,$=function(sel,root){return null==root&&(root=document),"object"==typeof sel||"undefined"!=typeof exports&&null!==exports?sel:root.querySelector(sel)},Util=function(){function Util(){}return Util.uniqid=function(){var id;return id=0,{get:function(){return id++}}}(),Util.extend=function(obj){var copy,dest,prop,src,_i,_len;for(dest=obj,src=slice.call(arguments,1),_i=0,_len=src.length;_len>_i;_i++){copy=src[_i];for(prop in copy)__hasProp.call(copy,prop)&&(dest[prop]=copy[prop])}return dest},Util.clampRGB=function(val){return 0>val?0:val>255?255:val},Util.copyAttributes=function(from,to,opts){var attr,_i,_len,_ref,_ref1,_results;for(null==opts&&(opts={}),_ref=from.attributes,_results=[],_i=0,_len=_ref.length;_len>_i;_i++)attr=_ref[_i],null!=opts.except&&(_ref1=attr.nodeName,__indexOf.call(opts.except,_ref1)>=0)||_results.push(to.setAttribute(attr.nodeName,attr.nodeValue));return _results},Util.dataArray=function(length){return null==length&&(length=0),Caman.NodeJS||null!=window.Uint8Array?new Uint8Array(length):new Array(length)},Util}(),"undefined"!=typeof exports&&null!==exports?(Root=exports,Canvas=require("canvas"),Image=Canvas.Image,Fiber=require("fibers"),fs=require("fs")):Root=window,Root.Caman=Caman=function(){function Caman(){var args,callback,id,_this=this;if(0===arguments.length)throw"Invalid arguments";return this instanceof Caman?(this.finishInit=this.finishInit.bind(this),this.imageLoaded=this.imageLoaded.bind(this),args=arguments[0],Caman.NodeJS||(id=parseInt(Caman.getAttrId(args[0]),10),callback="function"==typeof args[1]?args[1]:"function"==typeof args[2]?args[2]:function(){},isNaN(id)||!Store.has(id))?(this.id=Util.uniqid.get(),this.initializedPixelData=this.originalPixelData=null,this.cropCoordinates={x:0,y:0},this.cropped=!1,this.resized=!1,this.pixelStack=[],this.layerStack=[],this.canvasQueue=[],this.currentLayer=null,this.scaled=!1,this.analyze=new Analyze(this),this.renderer=new Renderer(this),this.domIsLoaded(function(){return _this.parseArguments(args),_this.setup()}),this):Store.execute(id,callback)):new Caman(arguments)}return Caman.version={release:"4.1.1",date:"4/8/2013"},Caman.DEBUG=!1,Caman.NodeJS="undefined"!=typeof exports&&null!==exports,Caman.autoload=!Caman.NodeJS,Caman.allowRevert=!0,Caman.crossOrigin="anonymous",Caman.toString=function(){return"Version "+Caman.version.release+", Released "+Caman.version.date},Caman.remoteProxy="",Caman.proxyParam="camanProxyUrl",Caman.getAttrId=function(canvas){return Caman.NodeJS?!0:("string"==typeof canvas&&(canvas=$(canvas)),null==canvas||null==canvas.getAttribute?null:canvas.getAttribute("data-caman-id"))},Caman.prototype.domIsLoaded=function(cb){var listener,_this=this;return Caman.NodeJS?setTimeout(function(){return cb.call(_this)},0):"complete"===document.readyState?(Log.debug("DOM initialized"),setTimeout(function(){return cb.call(_this)},0)):(listener=function(){return"complete"===document.readyState?(Log.debug("DOM initialized"),cb.call(_this)):void 0},document.addEventListener("readystatechange",listener,!1))},Caman.prototype.parseArguments=function(args){var key,val,_ref,_results;if(0===args.length)throw"Invalid arguments given";if(this.initObj=null,this.initType=null,this.imageUrl=null,this.callback=function(){},this.setInitObject(args[0]),1!==args.length){switch(typeof args[1]){case"string":this.imageUrl=args[1];break;case"function":this.callback=args[1]}if(2!==args.length&&(this.callback=args[2],4===args.length)){_ref=args[4],_results=[];for(key in _ref)__hasProp.call(_ref,key)&&(val=_ref[key],_results.push(this.options[key]=val));return _results}}},Caman.prototype.setInitObject=function(obj){if(Caman.NodeJS)return this.initObj=obj,void(this.initType="node");if(this.initObj="object"==typeof obj?obj:$(obj),null==this.initObj)throw"Could not find image or canvas for initialization.";return this.initType=this.initObj.nodeName.toLowerCase()},Caman.prototype.setup=function(){switch(this.initType){case"node":return this.initNode();case"img":return this.initImage();case"canvas":return this.initCanvas()}},Caman.prototype.initNode=function(){var _this=this;return Log.debug("Initializing for NodeJS"),this.image=new Image,this.image.onload=function(){return Log.debug("Image loaded. Width = "+_this.imageWidth()+", Height = "+_this.imageHeight()),_this.canvas=new Canvas(_this.imageWidth(),_this.imageHeight()),_this.finishInit()},this.image.onerror=function(err){throw err},this.image.src=this.initObj},Caman.prototype.initImage=function(){return this.image=this.initObj,this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),Util.copyAttributes(this.image,this.canvas,{except:["src"]}),this.image.parentNode.replaceChild(this.canvas,this.image),this.imageAdjustments(),this.waitForImageLoaded()},Caman.prototype.initCanvas=function(){return this.canvas=this.initObj,this.context=this.canvas.getContext("2d"),null!=this.imageUrl?(this.image=document.createElement("img"),this.image.src=this.imageUrl,this.imageAdjustments(),this.waitForImageLoaded()):this.finishInit()},Caman.prototype.imageAdjustments=function(){return this.needsHiDPISwap()&&(Log.debug(this.image.src,"->",this.hiDPIReplacement()),this.swapped=!0,this.image.src=this.hiDPIReplacement()),IO.isRemote(this.image)?(this.image.src=IO.proxyUrl(this.image.src),Log.debug("Remote image detected, using URL = "+this.image.src)):void 0},Caman.prototype.waitForImageLoaded=function(){return this.isImageLoaded()?this.imageLoaded():this.image.onload=this.imageLoaded},Caman.prototype.isImageLoaded=function(){return this.image.complete?null!=this.image.naturalWidth&&0===this.image.naturalWidth?!1:!0:!1},Caman.prototype.imageWidth=function(){return this.image.width||this.image.naturalWidth},Caman.prototype.imageHeight=function(){return this.image.height||this.image.naturalHeight},Caman.prototype.imageLoaded=function(){return Log.debug("Image loaded. Width = "+this.imageWidth()+", Height = "+this.imageHeight()),this.swapped?(this.canvas.width=this.imageWidth()/this.hiDPIRatio(),this.canvas.height=this.imageHeight()/this.hiDPIRatio()):(this.canvas.width=this.imageWidth(),this.canvas.height=this.imageHeight()),this.finishInit()},Caman.prototype.finishInit=function(){var i,pixel,_i,_len,_ref;if(null==this.context&&(this.context=this.canvas.getContext("2d")),this.originalWidth=this.preScaledWidth=this.width=this.canvas.width,this.originalHeight=this.preScaledHeight=this.height=this.canvas.height,this.hiDPIAdjustments(),this.hasId()||this.assignId(),null!=this.image&&this.context.drawImage(this.image,0,0,this.imageWidth(),this.imageHeight(),0,0,this.preScaledWidth,this.preScaledHeight),this.reloadCanvasData(),Caman.allowRevert)for(this.initializedPixelData=Util.dataArray(this.pixelData.length),this.originalPixelData=Util.dataArray(this.pixelData.length),_ref=this.pixelData,i=_i=0,_len=_ref.length;_len>_i;i=++_i)pixel=_ref[i],this.initializedPixelData[i]=pixel,this.originalPixelData[i]=pixel;return this.dimensions={width:this.canvas.width,height:this.canvas.height},Store.put(this.id,this),this.callback.call(this,this),this.callback=function(){}},Caman.prototype.reloadCanvasData=function(){return this.imageData=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),this.pixelData=this.imageData.data},Caman.prototype.resetOriginalPixelData=function(){var pixel,_i,_len,_ref,_results;if(!Caman.allowRevert)throw"Revert disabled";for(this.originalPixelData=Util.dataArray(this.pixelData.length),_ref=this.pixelData,_results=[],_i=0,_len=_ref.length;_len>_i;_i++)pixel=_ref[_i],_results.push(this.originalPixelData.push(pixel));return _results},Caman.prototype.hasId=function(){return null!=Caman.getAttrId(this.canvas)},Caman.prototype.assignId=function(){return Caman.NodeJS||this.canvas.getAttribute("data-caman-id")?void 0:this.canvas.setAttribute("data-caman-id",this.id)},Caman.prototype.hiDPIDisabled=function(){return null!==this.canvas.getAttribute("data-caman-hidpi-disabled")},Caman.prototype.hiDPIAdjustments=function(){var ratio;if(!Caman.NodeJS&&!this.hiDPIDisabled())return ratio=this.hiDPIRatio(),1!==ratio?(Log.debug("HiDPI ratio = "+ratio),this.scaled=!0,this.preScaledWidth=this.canvas.width,this.preScaledHeight=this.canvas.height,this.canvas.width=this.preScaledWidth*ratio,this.canvas.height=this.preScaledHeight*ratio,this.canvas.style.width=""+this.preScaledWidth+"px",this.canvas.style.height=""+this.preScaledHeight+"px",this.context.scale(ratio,ratio),this.width=this.originalWidth=this.canvas.width,this.height=this.originalHeight=this.canvas.height):void 0},Caman.prototype.hiDPIRatio=function(){var backingStoreRatio,devicePixelRatio;return devicePixelRatio=window.devicePixelRatio||1,backingStoreRatio=this.context.webkitBackingStorePixelRatio||this.context.mozBackingStorePixelRatio||this.context.msBackingStorePixelRatio||this.context.oBackingStorePixelRatio||this.context.backingStorePixelRatio||1,devicePixelRatio/backingStoreRatio},Caman.prototype.hiDPICapable=function(){return null!=window.devicePixelRatio&&1!==window.devicePixelRatio},Caman.prototype.needsHiDPISwap=function(){return this.hiDPIDisabled()||!this.hiDPICapable()?!1:null!==this.hiDPIReplacement()},Caman.prototype.hiDPIReplacement=function(){return null==this.image?null:this.image.getAttribute("data-caman-hidpi")},Caman.prototype.replaceCanvas=function(newCanvas){var oldCanvas;return oldCanvas=this.canvas,this.canvas=newCanvas,this.context=this.canvas.getContext("2d"),oldCanvas.parentNode.replaceChild(this.canvas,oldCanvas),this.width=this.canvas.width,this.height=this.canvas.height,this.reloadCanvasData(),this.dimensions={width:this.canvas.width,height:this.canvas.height}},Caman.prototype.render=function(callback){var _this=this;return null==callback&&(callback=function(){}),Event.trigger(this,"renderStart"),this.renderer.execute(function(){return _this.context.putImageData(_this.imageData,0,0),callback.call(_this)})},Caman.prototype.revert=function(){var i,pixel,_i,_len,_ref;if(!Caman.allowRevert)throw"Revert disabled";for(_ref=this.originalVisiblePixels(),i=_i=0,_len=_ref.length;_len>_i;i=++_i)pixel=_ref[i],this.pixelData[i]=pixel;return this.context.putImageData(this.imageData,0,0)},Caman.prototype.reset=function(){var canvas,ctx,i,imageData,pixel,pixelData,_i,_len,_ref;for(canvas=document.createElement("canvas"),Util.copyAttributes(this.canvas,canvas),canvas.width=this.originalWidth,canvas.height=this.originalHeight,ctx=canvas.getContext("2d"),imageData=ctx.getImageData(0,0,canvas.width,canvas.height),pixelData=imageData.data,_ref=this.initializedPixelData,i=_i=0,_len=_ref.length;_len>_i;i=++_i)pixel=_ref[i],pixelData[i]=pixel;return ctx.putImageData(imageData,0,0),this.cropCoordinates={x:0,y:0},this.resized=!1,this.replaceCanvas(canvas)},Caman.prototype.originalVisiblePixels=function(){var canvas,coord,ctx,endX,endY,i,imageData,pixel,pixelData,pixels,scaledCanvas,startX,startY,width,_i,_j,_len,_ref,_ref1,_ref2,_ref3;if(!Caman.allowRevert)throw"Revert disabled";if(pixels=[],startX=this.cropCoordinates.x,endX=startX+this.width,startY=this.cropCoordinates.y,endY=startY+this.height,this.resized){for(canvas=document.createElement("canvas"),canvas.width=this.originalWidth,canvas.height=this.originalHeight,ctx=canvas.getContext("2d"),imageData=ctx.getImageData(0,0,canvas.width,canvas.height),pixelData=imageData.data,_ref=this.originalPixelData,i=_i=0,_len=_ref.length;_len>_i;i=++_i)pixel=_ref[i],pixelData[i]=pixel;ctx.putImageData(imageData,0,0),scaledCanvas=document.createElement("canvas"),scaledCanvas.width=this.width,scaledCanvas.height=this.height,ctx=scaledCanvas.getContext("2d"),ctx.drawImage(canvas,0,0,this.originalWidth,this.originalHeight,0,0,this.width,this.height),pixelData=ctx.getImageData(0,0,this.width,this.height).data,width=this.width}else pixelData=this.originalPixelData,width=this.originalWidth;for(i=_j=0,_ref1=pixelData.length;_ref1>_j;i=_j+=4)coord=PixelInfo.locationToCoordinates(i,width),startX<=(_ref2=coord.x)&&endX>_ref2&&startY<=(_ref3=coord.y)&&endY>_ref3&&pixels.push(pixelData[i],pixelData[i+1],pixelData[i+2],pixelData[i+3]);return pixels},Caman.prototype.process=function(name,processFn){return this.renderer.add({type:Filter.Type.Single,name:name,processFn:processFn}),this},Caman.prototype.processKernel=function(name,adjust,divisor,bias){var i,_i,_ref;if(!divisor)for(divisor=0,i=_i=0,_ref=adjust.length;_ref>=0?_ref>_i:_i>_ref;i=_ref>=0?++_i:--_i)divisor+=adjust[i];return this.renderer.add({type:Filter.Type.Kernel,name:name,adjust:adjust,divisor:divisor,bias:bias||0}),this},Caman.prototype.processPlugin=function(plugin,args){return this.renderer.add({type:Filter.Type.Plugin,plugin:plugin,args:args}),this},Caman.prototype.newLayer=function(callback){var layer;return layer=new Layer(this),this.canvasQueue.push(layer),this.renderer.add({type:Filter.Type.LayerDequeue}),callback.call(layer),this.renderer.add({type:Filter.Type.LayerFinished}),this},Caman.prototype.executeLayer=function(layer){return this.pushContext(layer)},Caman.prototype.pushContext=function(layer){return this.layerStack.push(this.currentLayer),this.pixelStack.push(this.pixelData),this.currentLayer=layer,this.pixelData=layer.pixelData},Caman.prototype.popContext=function(){return this.pixelData=this.pixelStack.pop(),this.currentLayer=this.layerStack.pop()},Caman.prototype.applyCurrentLayer=function(){return this.currentLayer.applyToParent()},Caman}(),Analyze=function(){function Analyze(c){this.c=c}return Analyze.prototype.calculateLevels=function(){var i,levels,numPixels,_i,_j,_k,_ref;for(levels={r:{},g:{},b:{}},i=_i=0;255>=_i;i=++_i)levels.r[i]=0,levels.g[i]=0,levels.b[i]=0;for(i=_j=0,_ref=this.c.pixelData.length;_ref>_j;i=_j+=4)levels.r[this.c.pixelData[i]]++,levels.g[this.c.pixelData[i+1]]++,levels.b[this.c.pixelData[i+2]]++;for(numPixels=this.c.pixelData.length/4,i=_k=0;255>=_k;i=++_k)levels.r[i]/=numPixels,levels.g[i]/=numPixels,levels.b[i]/=numPixels;return levels},Analyze}(),Caman.DOMUpdated=function(){var img,imgs,parser,_i,_len,_results;if(imgs=document.querySelectorAll("img[data-caman]"),imgs.length>0){for(_results=[],_i=0,_len=imgs.length;_len>_i;_i++)img=imgs[_i],_results.push(parser=new CamanParser(img,function(){return this.parse(),this.execute()}));return _results}},Caman.autoload&&!function(){return"complete"===document.readyState?Caman.DOMUpdated():document.addEventListener("DOMContentLoaded",Caman.DOMUpdated,!1)}(),CamanParser=function(){function CamanParser(ele,ready){this.dataStr=ele.getAttribute("data-caman"),this.caman=Caman(ele,ready.bind(this))}var INST_REGEX;return INST_REGEX="(\\w+)\\((.*?)\\)",CamanParser.prototype.parse=function(){var args,filter,func,inst,instFunc,m,r,unparsedInstructions,_i,_len,_ref,_results;if(this.ele=this.caman.canvas,r=new RegExp(INST_REGEX,"g"),unparsedInstructions=this.dataStr.match(r),unparsedInstructions.length>0){for(r=new RegExp(INST_REGEX),_results=[],_i=0,_len=unparsedInstructions.length;_len>_i;_i++){inst=unparsedInstructions[_i],_ref=inst.match(r),m=_ref[0],filter=_ref[1],args=_ref[2],instFunc=new Function("return function() {        this."+filter+"("+args+");      };");try{func=instFunc(),_results.push(func.call(this.caman))}catch(e){_results.push(Log.debug(e))}}return _results}},CamanParser.prototype.execute=function(){var ele;return ele=this.ele,this.caman.render(function(){return ele.parentNode.replaceChild(this.toImage(),ele)})},CamanParser}(),Caman.Blender=Blender=function(){function Blender(){}return Blender.blenders={},Blender.register=function(name,func){return this.blenders[name]=func},Blender.execute=function(name,rgbaLayer,rgbaParent){return this.blenders[name](rgbaLayer,rgbaParent)},Blender}(),Caman.Calculate=Calculate=function(){function Calculate(){}return Calculate.distance=function(x1,y1,x2,y2){return Math.sqrt(Math.pow(x2-x1,2)+Math.pow(y2-y1,2))},Calculate.randomRange=function(min,max,getFloat){var rand;return null==getFloat&&(getFloat=!1),rand=min+Math.random()*(max-min),getFloat?rand.toFixed(getFloat):Math.round(rand)},Calculate.luminance=function(rgba){return.299*rgba.r+.587*rgba.g+.114*rgba.b},Calculate.bezier=function(start,ctrl1,ctrl2,end,lowBound,highBound){var Ax,Ay,Bx,By,Cx,Cy,bezier,curveX,curveY,i,j,leftCoord,rightCoord,t,x0,x1,x2,x3,y0,y1,y2,y3,_i,_j,_k,_ref,_ref1;for(x0=start[0],y0=start[1],x1=ctrl1[0],y1=ctrl1[1],x2=ctrl2[0],y2=ctrl2[1],x3=end[0],y3=end[1],bezier={},Cx=parseInt(3*(x1-x0),10),Bx=3*(x2-x1)-Cx,Ax=x3-x0-Cx-Bx,Cy=3*(y1-y0),By=3*(y2-y1)-Cy,Ay=y3-y0-Cy-By,i=_i=0;1e3>_i;i=++_i)t=i/1e3,curveX=Math.round(Ax*Math.pow(t,3)+Bx*Math.pow(t,2)+Cx*t+x0),curveY=Math.round(Ay*Math.pow(t,3)+By*Math.pow(t,2)+Cy*t+y0),lowBound&&lowBound>curveY?curveY=lowBound:highBound&&curveY>highBound&&(curveY=highBound),bezier[curveX]=curveY;if(bezier.length<end[0]+1)for(i=_j=0,_ref=end[0];_ref>=0?_ref>=_j:_j>=_ref;i=_ref>=0?++_j:--_j)if(null==bezier[i]){for(leftCoord=[i-1,bezier[i-1]],j=_k=i,_ref1=end[0];_ref1>=i?_ref1>=_k:_k>=_ref1;j=_ref1>=i?++_k:--_k)if(null!=bezier[j]){rightCoord=[j,bezier[j]];break}bezier[i]=leftCoord[1]+(rightCoord[1]-leftCoord[1])/(rightCoord[0]-leftCoord[0])*(i-leftCoord[0])}return null==bezier[end[0]]&&(bezier[end[0]]=bezier[end[0]-1]),bezier},Calculate}(),Convert=function(){function Convert(){}return Convert.hexToRGB=function(hex){var b,g,r;return"#"===hex.charAt(0)&&(hex=hex.substr(1)),r=parseInt(hex.substr(0,2),16),g=parseInt(hex.substr(2,2),16),b=parseInt(hex.substr(4,2),16),{r:r,g:g,b:b}},Convert.rgbToHSL=function(r,g,b){var d,h,l,max,min,s;return"object"==typeof r&&(g=r.g,b=r.b,r=r.r),r/=255,g/=255,b/=255,max=Math.max(r,g,b),min=Math.min(r,g,b),l=(max+min)/2,max===min?h=s=0:(d=max-min,s=l>.5?d/(2-max-min):d/(max+min),h=function(){switch(max){case r:return(g-b)/d+(b>g?6:0);case g:return(b-r)/d+2;case b:return(r-g)/d+4}}(),h/=6),{h:h,s:s,l:l}},Convert.hslToRGB=function(h,s,l){var b,g,p,q,r;return"object"==typeof h&&(s=h.s,l=h.l,h=h.h),0===s?r=g=b=l:(q=.5>l?l*(1+s):l+s-l*s,p=2*l-q,r=this.hueToRGB(p,q,h+1/3),g=this.hueToRGB(p,q,h),b=this.hueToRGB(p,q,h-1/3)),{r:255*r,g:255*g,b:255*b}},Convert.hueToRGB=function(p,q,t){return 0>t&&(t+=1),t>1&&(t-=1),1/6>t?p+6*(q-p)*t:.5>t?q:2/3>t?p+(q-p)*(2/3-t)*6:p},Convert.rgbToHSV=function(r,g,b){var d,h,max,min,s,v;return r/=255,g/=255,b/=255,max=Math.max(r,g,b),min=Math.min(r,g,b),v=max,d=max-min,s=0===max?0:d/max,max===min?h=0:(h=function(){switch(max){case r:return(g-b)/d+(b>g?6:0);case g:return(b-r)/d+2;case b:return(r-g)/d+4}}(),h/=6),{h:h,s:s,v:v}},Convert.hsvToRGB=function(h,s,v){var b,f,g,i,p,q,r,t;switch(i=Math.floor(6*h),f=6*h-i,p=v*(1-s),q=v*(1-f*s),t=v*(1-(1-f)*s),i%6){case 0:r=v,g=t,b=p;break;case 1:r=q,g=v,b=p;break;case 2:r=p,g=v,b=t;break;case 3:r=p,g=q,b=v;break;case 4:r=t,g=p,b=v;break;case 5:r=v,g=p,b=q}return{r:255*r,g:255*g,b:255*b}},Convert.rgbToXYZ=function(r,g,b){var x,y,z;return r/=255,g/=255,b/=255,r>.04045?r=Math.pow((r+.055)/1.055,2.4):r/=12.92,g>.04045?g=Math.pow((g+.055)/1.055,2.4):g/=12.92,b>.04045?b=Math.pow((b+.055)/1.055,2.4):b/=12.92,x=.4124*r+.3576*g+.1805*b,y=.2126*r+.7152*g+.0722*b,z=.0193*r+.1192*g+.9505*b,{x:100*x,y:100*y,z:100*z}},Convert.xyzToRGB=function(x,y,z){var b,g,r;return x/=100,y/=100,z/=100,r=3.2406*x+-1.5372*y+-.4986*z,g=-.9689*x+1.8758*y+.0415*z,b=.0557*x+-.204*y+1.057*z,r>.0031308?r=1.055*Math.pow(r,.4166666667)-.055:r*=12.92,g>.0031308?g=1.055*Math.pow(g,.4166666667)-.055:g*=12.92,b>.0031308?b=1.055*Math.pow(b,.4166666667)-.055:b*=12.92,{r:255*r,g:255*g,b:255*b}},Convert.xyzToLab=function(x,y,z){var a,b,l,whiteX,whiteY,whiteZ;return"object"==typeof x&&(y=x.y,z=x.z,x=x.x),whiteX=95.047,whiteY=100,whiteZ=108.883,x/=whiteX,y/=whiteY,z/=whiteZ,x=x>.008856451679?Math.pow(x,.3333333333):7.787037037*x+.1379310345,y=y>.008856451679?Math.pow(y,.3333333333):7.787037037*y+.1379310345,z=z>.008856451679?Math.pow(z,.3333333333):7.787037037*z+.1379310345,l=116*y-16,a=500*(x-y),b=200*(y-z),{l:l,a:a,b:b}},Convert.labToXYZ=function(l,a,b){var x,y,z;return"object"==typeof l&&(a=l.a,b=l.b,l=l.l),y=(l+16)/116,x=y+a/500,z=y-b/200,x=x>.2068965517?x*x*x:.1284185493*(x-.1379310345),y=y>.2068965517?y*y*y:.1284185493*(y-.1379310345),z=z>.2068965517?z*z*z:.1284185493*(z-.1379310345),{x:95.047*x,y:100*y,z:108.883*z}},Convert.rgbToLab=function(r,g,b){var xyz;return"object"==typeof r&&(g=r.g,b=r.b,r=r.r),xyz=this.rgbToXYZ(r,g,b),this.xyzToLab(xyz)},Convert.labToRGB=function(){},Convert}(),Event=function(){function Event(){}return Event.events={},Event.types=["processStart","processComplete","renderStart","renderFinished","blockStarted","blockFinished"],Event.trigger=function(target,type,data){var event,_i,_len,_ref,_results;if(this.events[type]&&this.events[type].length){for(_ref=this.events[type],_results=[],_i=0,_len=_ref.length;_len>_i;_i++)event=_ref[_i],_results.push(null===event.target||target.id===event.target.id?event.fn.call(target,data):void 0);return _results}},Event.listen=function(target,type,fn){var _fn,_type;return"string"==typeof target&&(_type=target,_fn=type,target=null,type=_type,fn=_fn),__indexOf.call(this.types,type)<0?!1:(this.events[type]||(this.events[type]=[]),this.events[type].push({target:target,fn:fn}),!0)},Event}(),Caman.Event=Event,Caman.Filter=Filter=function(){function Filter(){}return Filter.Type={Single:1,Kernel:2,LayerDequeue:3,LayerFinished:4,LoadOverlay:5,Plugin:6},Filter.register=function(name,filterFunc){return Caman.prototype[name]=filterFunc},Filter}(),Caman.IO=IO=function(){function IO(){}return IO.domainRegex=/(?:(?:http|https):\/\/)((?:\w+)\.(?:(?:\w|\.)+))/,IO.isRemote=function(img){return null==img?!1:this.corsEnabled(img)?!1:this.isURLRemote(img.src)},IO.corsEnabled=function(img){var _ref;return null!=img.crossOrigin&&("anonymous"===(_ref=img.crossOrigin.toLowerCase())||"use-credentials"===_ref)},IO.isURLRemote=function(url){var matches;return matches=url.match(this.domainRegex),matches?matches[1]!==document.domain:!1},IO.remoteCheck=function(src){if(this.isURLRemote(src)){if(Caman.remoteProxy.length)return Caman.isURLRemote(Caman.remoteProxy)?void Log.info("Cannot use a remote proxy for loading images."):""+Caman.remoteProxy+"?camanProxyUrl="+encodeURIComponent(src);Log.info("Attempting to load a remote image without a configured proxy. URL: "+src)}},IO.proxyUrl=function(src){return""+Caman.remoteProxy+"?"+Caman.proxyParam+"="+encodeURIComponent(src)},IO.useProxy=function(lang){var langToExt;return langToExt={ruby:"rb",python:"py",perl:"pl",javascript:"js"},lang=lang.toLowerCase(),null!=langToExt[lang]&&(lang=langToExt[lang]),"proxies/caman_proxy."+lang},IO}(),Caman.prototype.save=function(){return"undefined"!=typeof exports&&null!==exports?this.nodeSave.apply(this,arguments):this.browserSave.apply(this,arguments)},Caman.prototype.browserSave=function(type){var image;return null==type&&(type="png"),type=type.toLowerCase(),image=this.toBase64(type).replace("image/"+type,"image/octet-stream"),document.location.href=image},Caman.prototype.nodeSave=function(file,overwrite){var stats;null==overwrite&&(overwrite=!0);try{if(stats=fs.statSync(file),stats.isFile()&&!overwrite)return!1}catch(e){Log.debug("Creating output file "+file)}return fs.writeFile(file,this.canvas.toBuffer(),function(){return Log.debug("Finished writing to "+file)})},Caman.prototype.toImage=function(type){var img;return img=document.createElement("img"),img.src=this.toBase64(type),img.width=this.dimensions.width,img.height=this.dimensions.height,window.devicePixelRatio&&(img.width/=window.devicePixelRatio,img.height/=window.devicePixelRatio),img},Caman.prototype.toBase64=function(type){return null==type&&(type="png"),type=type.toLowerCase(),this.canvas.toDataURL("image/"+type)},Layer=function(){function Layer(c){this.c=c,this.filter=this.c,this.options={blendingMode:"normal",opacity:1},this.layerID=Util.uniqid.get(),this.canvas="undefined"!=typeof exports&&null!==exports?new Canvas:document.createElement("canvas"),this.canvas.width=this.c.dimensions.width,this.canvas.height=this.c.dimensions.height,this.context=this.canvas.getContext("2d"),this.context.createImageData(this.canvas.width,this.canvas.height),this.imageData=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),this.pixelData=this.imageData.data}return Layer.prototype.newLayer=function(cb){return this.c.newLayer.call(this.c,cb)},Layer.prototype.setBlendingMode=function(mode){return this.options.blendingMode=mode,this},Layer.prototype.opacity=function(opacity){return this.options.opacity=opacity/100,this},Layer.prototype.copyParent=function(){var i,parentData,_i,_ref;for(parentData=this.c.pixelData,i=_i=0,_ref=this.c.pixelData.length;_ref>_i;i=_i+=4)this.pixelData[i]=parentData[i],this.pixelData[i+1]=parentData[i+1],this.pixelData[i+2]=parentData[i+2],this.pixelData[i+3]=parentData[i+3];return this},Layer.prototype.fillColor=function(){return this.c.fillColor.apply(this.c,arguments)},Layer.prototype.overlayImage=function(image){return"object"==typeof image?image=image.src:"string"==typeof image&&"#"===image[0]&&(image=$(image).src),image?(this.c.renderer.renderQueue.push({type:Filter.Type.LoadOverlay,src:image,layer:this}),this):this},Layer.prototype.applyToParent=function(){var i,layerData,parentData,result,rgbaLayer,rgbaParent,_i,_ref,_results;for(parentData=this.c.pixelStack[this.c.pixelStack.length-1],layerData=this.c.pixelData,_results=[],i=_i=0,_ref=layerData.length;_ref>_i;i=_i+=4)rgbaParent={r:parentData[i],g:parentData[i+1],b:parentData[i+2],a:parentData[i+3]},rgbaLayer={r:layerData[i],g:layerData[i+1],b:layerData[i+2],a:layerData[i+3]},result=Blender.execute(this.options.blendingMode,rgbaLayer,rgbaParent),result.r=Util.clampRGB(result.r),result.g=Util.clampRGB(result.g),result.b=Util.clampRGB(result.b),null==result.a&&(result.a=rgbaLayer.a),parentData[i]=rgbaParent.r-(rgbaParent.r-result.r)*this.options.opacity*(result.a/255),parentData[i+1]=rgbaParent.g-(rgbaParent.g-result.g)*this.options.opacity*(result.a/255),_results.push(parentData[i+2]=rgbaParent.b-(rgbaParent.b-result.b)*this.options.opacity*(result.a/255));return _results},Layer}(),Logger=function(){function Logger(){var name,_i,_len,_ref;for(_ref=["log","info","warn","error"],_i=0,_len=_ref.length;_len>_i;_i++)name=_ref[_i],this[name]=function(name){return function(){var args;if(args=1<=arguments.length?__slice.call(arguments,0):[],Caman.DEBUG)try{return console[name].apply(console,args)}catch(e){return console[name](args)}}}(name);this.debug=this.log}return Logger}(),Log=new Logger,PixelInfo=function(){function PixelInfo(c){this.c=c,this.loc=0}return PixelInfo.coordinatesToLocation=function(x,y,width){return 4*(y*width+x)},PixelInfo.locationToCoordinates=function(loc,width){var x,y;return y=Math.floor(loc/(4*width)),x=loc%(4*width)/4,{x:x,y:y}},PixelInfo.prototype.locationXY=function(){var x,y;return y=this.c.dimensions.height-Math.floor(this.loc/(4*this.c.dimensions.width)),x=this.loc%(4*this.c.dimensions.width)/4,{x:x,y:y}},PixelInfo.prototype.getPixelRelative=function(horiz,vert){var newLoc;return newLoc=this.loc+4*this.c.dimensions.width*-1*vert+4*horiz,newLoc>this.c.pixelData.length||0>newLoc?{r:0,g:0,b:0,a:0}:{r:this.c.pixelData[newLoc],g:this.c.pixelData[newLoc+1],b:this.c.pixelData[newLoc+2],a:this.c.pixelData[newLoc+3]}},PixelInfo.prototype.putPixelRelative=function(horiz,vert,rgba){var nowLoc;return nowLoc=this.loc+4*this.c.dimensions.width*-1*vert+4*horiz,newLoc>this.c.pixelData.length||0>newLoc?void 0:(this.c.pixelData[newLoc]=rgba.r,this.c.pixelData[newLoc+1]=rgba.g,this.c.pixelData[newLoc+2]=rgba.b,this.c.pixelData[newLoc+3]=rgba.a,!0)},PixelInfo.prototype.getPixel=function(x,y){var loc;return loc=this.coordinatesToLocation(x,y,this.width),{r:this.c.pixelData[loc],g:this.c.pixelData[loc+1],b:this.c.pixelData[loc+2],a:this.c.pixelData[loc+3]}},PixelInfo.prototype.putPixel=function(x,y,rgba){var loc;return loc=this.coordinatesToLocation(x,y,this.width),this.c.pixelData[loc]=rgba.r,this.c.pixelData[loc+1]=rgba.g,this.c.pixelData[loc+2]=rgba.b,this.c.pixelData[loc+3]=rgba.a},PixelInfo}(),Plugin=function(){function Plugin(){}return Plugin.plugins={},Plugin.register=function(name,plugin){return this.plugins[name]=plugin},Plugin.execute=function(context,name,args){return this.plugins[name].apply(context,args)},Plugin}(),Caman.Plugin=Plugin,Caman.Renderer=Renderer=function(){function Renderer(c){var _this=this;this.c=c,this.processNext=function(){return Renderer.prototype.processNext.apply(_this,arguments)},this.renderQueue=[],this.modPixelData=null}return Renderer.Blocks=Caman.NodeJS?require("os").cpus().length:4,Renderer.prototype.add=function(job){return null!=job?this.renderQueue.push(job):void 0},Renderer.prototype.processNext=function(){var layer;if(0===this.renderQueue.length)return Event.trigger(this,"renderFinished"),null!=this.finishedFn&&this.finishedFn.call(this.c),this;switch(this.currentJob=this.renderQueue.shift(),this.currentJob.type){case Filter.Type.LayerDequeue:return layer=this.c.canvasQueue.shift(),this.c.executeLayer(layer),this.processNext();case Filter.Type.LayerFinished:return this.c.applyCurrentLayer(),this.c.popContext(),this.processNext();case Filter.Type.LoadOverlay:return this.loadOverlay(this.currentJob.layer,this.currentJob.src);case Filter.Type.Plugin:return this.executePlugin();default:return this.executeFilter()}},Renderer.prototype.execute=function(callback){return this.finishedFn=callback,this.modPixelData=Util.dataArray(this.c.pixelData.length),this.processNext()},Renderer.prototype.eachBlock=function(fn){var blockN,blockPixelLength,bnum,end,f,i,lastBlockN,n,start,_i,_ref,_results,_this=this;for(this.blocksDone=0,n=this.c.pixelData.length,blockPixelLength=Math.floor(n/4/Renderer.Blocks),blockN=4*blockPixelLength,lastBlockN=blockN+n/4%Renderer.Blocks*4,_results=[],i=_i=0,_ref=Renderer.Blocks;_ref>=0?_ref>_i:_i>_ref;i=_ref>=0?++_i:--_i)start=i*blockN,end=start+(i===Renderer.Blocks-1?lastBlockN:blockN),Caman.NodeJS?(f=Fiber(function(){return fn.call(_this,i,start,end)}),bnum=f.run(),_results.push(this.blockFinished(bnum))):_results.push(setTimeout(function(i,start,end){return function(){return fn.call(_this,i,start,end)}}(i,start,end),0));return _results},Renderer.prototype.executeFilter=function(){return Event.trigger(this.c,"processStart",this.currentJob),this.eachBlock(this.currentJob.type===Filter.Type.Single?this.renderBlock:this.renderKernel)
},Renderer.prototype.executePlugin=function(){return Log.debug("Executing plugin "+this.currentJob.plugin),Plugin.execute(this.c,this.currentJob.plugin,this.currentJob.args),Log.debug("Plugin "+this.currentJob.plugin+" finished!"),this.processNext()},Renderer.prototype.renderBlock=function(bnum,start,end){var data,i,pixelInfo,res,_i;for(Log.debug("Block #"+bnum+" - Filter: "+this.currentJob.name+", Start: "+start+", End: "+end),Event.trigger(this.c,"blockStarted",{blockNum:bnum,totalBlocks:Renderer.Blocks,startPixel:start,endPixel:end}),data={r:0,g:0,b:0,a:0},pixelInfo=new PixelInfo(this.c),i=_i=start;end>_i;i=_i+=4)pixelInfo.loc=i,data.r=this.c.pixelData[i],data.g=this.c.pixelData[i+1],data.b=this.c.pixelData[i+2],data.a=this.c.pixelData[i+3],res=this.currentJob.processFn.call(pixelInfo,data),null==res.a&&(res.a=data.a),this.c.pixelData[i]=Util.clampRGB(res.r),this.c.pixelData[i+1]=Util.clampRGB(res.g),this.c.pixelData[i+2]=Util.clampRGB(res.b),this.c.pixelData[i+3]=Util.clampRGB(res.a);return Caman.NodeJS?Fiber["yield"](bnum):this.blockFinished(bnum)},Renderer.prototype.renderKernel=function(bnum,start,end){var adjust,adjustSize,bias,builder,builderIndex,divisor,i,j,k,kernel,n,name,pixel,pixelInfo,res,_i,_j,_k;for(name=this.currentJob.name,bias=this.currentJob.bias,divisor=this.currentJob.divisor,n=this.c.pixelData.length,adjust=this.currentJob.adjust,adjustSize=Math.sqrt(adjust.length),kernel=[],Log.debug("Rendering kernel - Filter: "+this.currentJob.name),start=Math.max(start,4*this.c.dimensions.width*((adjustSize-1)/2)),end=Math.min(end,n-4*this.c.dimensions.width*((adjustSize-1)/2)),builder=(adjustSize-1)/2,pixelInfo=new PixelInfo(this.c),i=_i=start;end>_i;i=_i+=4){for(pixelInfo.loc=i,builderIndex=0,j=_j=-builder;builder>=-builder?builder>=_j:_j>=builder;j=builder>=-builder?++_j:--_j)for(k=_k=builder;-builder>=builder?-builder>=_k:_k>=-builder;k=-builder>=builder?++_k:--_k)pixel=pixelInfo.getPixelRelative(j,k),kernel[3*builderIndex]=pixel.r,kernel[3*builderIndex+1]=pixel.g,kernel[3*builderIndex+2]=pixel.b,builderIndex++;res=this.processKernel(adjust,kernel,divisor,bias),this.modPixelData[i]=Util.clampRGB(res.r),this.modPixelData[i+1]=Util.clampRGB(res.g),this.modPixelData[i+2]=Util.clampRGB(res.b),this.modPixelData[i+3]=this.c.pixelData[i+3]}return Caman.NodeJS?Fiber["yield"](bnum):this.blockFinished(bnum)},Renderer.prototype.blockFinished=function(bnum){var i,_i,_ref;if(bnum>=0&&Log.debug("Block #"+bnum+" finished! Filter: "+this.currentJob.name),this.blocksDone++,Event.trigger(this.c,"blockFinished",{blockNum:bnum,blocksFinished:this.blocksDone,totalBlocks:Renderer.Blocks}),this.blocksDone===Renderer.Blocks){if(this.currentJob.type===Filter.Type.Kernel)for(i=_i=0,_ref=this.c.pixelData.length;_ref>=0?_ref>_i:_i>_ref;i=_ref>=0?++_i:--_i)this.c.pixelData[i]=this.modPixelData[i];return bnum>=0&&Log.debug("Filter "+this.currentJob.name+" finished!"),Event.trigger(this.c,"processComplete",this.currentJob),this.processNext()}},Renderer.prototype.processKernel=function(adjust,kernel,divisor,bias){var i,val,_i,_ref;for(val={r:0,g:0,b:0},i=_i=0,_ref=adjust.length;_ref>=0?_ref>_i:_i>_ref;i=_ref>=0?++_i:--_i)val.r+=adjust[i]*kernel[3*i],val.g+=adjust[i]*kernel[3*i+1],val.b+=adjust[i]*kernel[3*i+2];return val.r=val.r/divisor+bias,val.g=val.g/divisor+bias,val.b=val.b/divisor+bias,val},Renderer.prototype.loadOverlay=function(layer,src){var img,proxyUrl,_this=this;return img=document.createElement("img"),img.onload=function(){return layer.context.drawImage(img,0,0,_this.c.dimensions.width,_this.c.dimensions.height),layer.imageData=layer.context.getImageData(0,0,_this.c.dimensions.width,_this.c.dimensions.height),layer.pixelData=layer.imageData.data,_this.c.pixelData=layer.pixelData,_this.processNext()},proxyUrl=IO.remoteCheck(src),img.src=null!=proxyUrl?proxyUrl:src},Renderer}(),Caman.Store=Store=function(){function Store(){}return Store.items={},Store.has=function(search){return null!=this.items[search]},Store.get=function(search){return this.items[search]},Store.put=function(name,obj){return this.items[name]=obj},Store.execute=function(search,callback){var _this=this;return setTimeout(function(){return callback.call(_this.get(search),_this.get(search))},0),this.get(search)},Store.flush=function(name){return null==name&&(name=!1),name?delete this.items[name]:this.items={}},Store}(),Blender.register("normal",function(rgbaLayer){return{r:rgbaLayer.r,g:rgbaLayer.g,b:rgbaLayer.b}}),Blender.register("multiply",function(rgbaLayer,rgbaParent){return{r:rgbaLayer.r*rgbaParent.r/255,g:rgbaLayer.g*rgbaParent.g/255,b:rgbaLayer.b*rgbaParent.b/255}}),Blender.register("screen",function(rgbaLayer,rgbaParent){return{r:255-(255-rgbaLayer.r)*(255-rgbaParent.r)/255,g:255-(255-rgbaLayer.g)*(255-rgbaParent.g)/255,b:255-(255-rgbaLayer.b)*(255-rgbaParent.b)/255}}),Blender.register("overlay",function(rgbaLayer,rgbaParent){var result;return result={},result.r=rgbaParent.r>128?255-2*(255-rgbaLayer.r)*(255-rgbaParent.r)/255:rgbaParent.r*rgbaLayer.r*2/255,result.g=rgbaParent.g>128?255-2*(255-rgbaLayer.g)*(255-rgbaParent.g)/255:rgbaParent.g*rgbaLayer.g*2/255,result.b=rgbaParent.b>128?255-2*(255-rgbaLayer.b)*(255-rgbaParent.b)/255:rgbaParent.b*rgbaLayer.b*2/255,result}),Blender.register("difference",function(rgbaLayer,rgbaParent){return{r:rgbaLayer.r-rgbaParent.r,g:rgbaLayer.g-rgbaParent.g,b:rgbaLayer.b-rgbaParent.b}}),Blender.register("addition",function(rgbaLayer,rgbaParent){return{r:rgbaParent.r+rgbaLayer.r,g:rgbaParent.g+rgbaLayer.g,b:rgbaParent.b+rgbaLayer.b}}),Blender.register("exclusion",function(rgbaLayer,rgbaParent){return{r:128-2*(rgbaParent.r-128)*(rgbaLayer.r-128)/255,g:128-2*(rgbaParent.g-128)*(rgbaLayer.g-128)/255,b:128-2*(rgbaParent.b-128)*(rgbaLayer.b-128)/255}}),Blender.register("softLight",function(rgbaLayer,rgbaParent){var result;return result={},result.r=rgbaParent.r>128?255-(255-rgbaParent.r)*(255-(rgbaLayer.r-128))/255:rgbaParent.r*(rgbaLayer.r+128)/255,result.g=rgbaParent.g>128?255-(255-rgbaParent.g)*(255-(rgbaLayer.g-128))/255:rgbaParent.g*(rgbaLayer.g+128)/255,result.b=rgbaParent.b>128?255-(255-rgbaParent.b)*(255-(rgbaLayer.b-128))/255:rgbaParent.b*(rgbaLayer.b+128)/255,result}),Blender.register("lighten",function(rgbaLayer,rgbaParent){return{r:rgbaParent.r>rgbaLayer.r?rgbaParent.r:rgbaLayer.r,g:rgbaParent.g>rgbaLayer.g?rgbaParent.g:rgbaLayer.g,b:rgbaParent.b>rgbaLayer.b?rgbaParent.b:rgbaLayer.b}}),Blender.register("darken",function(rgbaLayer,rgbaParent){return{r:rgbaParent.r>rgbaLayer.r?rgbaLayer.r:rgbaParent.r,g:rgbaParent.g>rgbaLayer.g?rgbaLayer.g:rgbaParent.g,b:rgbaParent.b>rgbaLayer.b?rgbaLayer.b:rgbaParent.b}}),Filter.register("fillColor",function(){var color;return color=1===arguments.length?Convert.hexToRGB(arguments[0]):{r:arguments[0],g:arguments[1],b:arguments[2]},this.process("fillColor",function(rgba){return rgba.r=color.r,rgba.g=color.g,rgba.b=color.b,rgba.a=255,rgba})}),Filter.register("brightness",function(adjust){return adjust=Math.floor(255*(adjust/100)),this.process("brightness",function(rgba){return rgba.r+=adjust,rgba.g+=adjust,rgba.b+=adjust,rgba})}),Filter.register("saturation",function(adjust){return adjust*=-.01,this.process("saturation",function(rgba){var max;return max=Math.max(rgba.r,rgba.g,rgba.b),rgba.r!==max&&(rgba.r+=(max-rgba.r)*adjust),rgba.g!==max&&(rgba.g+=(max-rgba.g)*adjust),rgba.b!==max&&(rgba.b+=(max-rgba.b)*adjust),rgba})}),Filter.register("vibrance",function(adjust){return adjust*=-1,this.process("vibrance",function(rgba){var amt,avg,max;return max=Math.max(rgba.r,rgba.g,rgba.b),avg=(rgba.r+rgba.g+rgba.b)/3,amt=2*Math.abs(max-avg)/255*adjust/100,rgba.r!==max&&(rgba.r+=(max-rgba.r)*amt),rgba.g!==max&&(rgba.g+=(max-rgba.g)*amt),rgba.b!==max&&(rgba.b+=(max-rgba.b)*amt),rgba})}),Filter.register("greyscale",function(){return this.process("greyscale",function(rgba){var avg;return avg=Calculate.luminance(rgba),rgba.r=avg,rgba.g=avg,rgba.b=avg,rgba})}),Filter.register("contrast",function(adjust){return adjust=Math.pow((adjust+100)/100,2),this.process("contrast",function(rgba){return rgba.r/=255,rgba.r-=.5,rgba.r*=adjust,rgba.r+=.5,rgba.r*=255,rgba.g/=255,rgba.g-=.5,rgba.g*=adjust,rgba.g+=.5,rgba.g*=255,rgba.b/=255,rgba.b-=.5,rgba.b*=adjust,rgba.b+=.5,rgba.b*=255,rgba})}),Filter.register("hue",function(adjust){return this.process("hue",function(rgba){var h,hsv,rgb;return hsv=Convert.rgbToHSV(rgba.r,rgba.g,rgba.b),h=100*hsv.h,h+=Math.abs(adjust),h%=100,h/=100,hsv.h=h,rgb=Convert.hsvToRGB(hsv.h,hsv.s,hsv.v),rgb.a=rgba.a,rgb})}),Filter.register("colorize",function(){var level,rgb;return 2===arguments.length?(rgb=Convert.hexToRGB(arguments[0]),level=arguments[1]):4===arguments.length&&(rgb={r:arguments[0],g:arguments[1],b:arguments[2]},level=arguments[3]),this.process("colorize",function(rgba){return rgba.r-=(rgba.r-rgb.r)*(level/100),rgba.g-=(rgba.g-rgb.g)*(level/100),rgba.b-=(rgba.b-rgb.b)*(level/100),rgba})}),Filter.register("invert",function(){return this.process("invert",function(rgba){return rgba.r=255-rgba.r,rgba.g=255-rgba.g,rgba.b=255-rgba.b,rgba})}),Filter.register("sepia",function(adjust){return null==adjust&&(adjust=100),adjust/=100,this.process("sepia",function(rgba){return rgba.r=Math.min(255,rgba.r*(1-.607*adjust)+.769*rgba.g*adjust+.189*rgba.b*adjust),rgba.g=Math.min(255,.349*rgba.r*adjust+rgba.g*(1-.314*adjust)+.168*rgba.b*adjust),rgba.b=Math.min(255,.272*rgba.r*adjust+.534*rgba.g*adjust+rgba.b*(1-.869*adjust)),rgba})}),Filter.register("gamma",function(adjust){return this.process("gamma",function(rgba){return rgba.r=255*Math.pow(rgba.r/255,adjust),rgba.g=255*Math.pow(rgba.g/255,adjust),rgba.b=255*Math.pow(rgba.b/255,adjust),rgba})}),Filter.register("noise",function(adjust){return adjust=2.55*Math.abs(adjust),this.process("noise",function(rgba){var rand;return rand=Calculate.randomRange(-1*adjust,adjust),rgba.r+=rand,rgba.g+=rand,rgba.b+=rand,rgba})}),Filter.register("clip",function(adjust){return adjust=2.55*Math.abs(adjust),this.process("clip",function(rgba){return rgba.r>255-adjust?rgba.r=255:rgba.r<adjust&&(rgba.r=0),rgba.g>255-adjust?rgba.g=255:rgba.g<adjust&&(rgba.g=0),rgba.b>255-adjust?rgba.b=255:rgba.b<adjust&&(rgba.b=0),rgba})}),Filter.register("channels",function(options){var chan,value;if("object"!=typeof options)return this;for(chan in options)__hasProp.call(options,chan)&&(value=options[chan],0!==value?options[chan]/=100:delete options[chan]);return 0===options.length?this:this.process("channels",function(rgba){return null!=options.red&&(options.red>0?rgba.r+=(255-rgba.r)*options.red:rgba.r-=rgba.r*Math.abs(options.red)),null!=options.green&&(options.green>0?rgba.g+=(255-rgba.g)*options.green:rgba.g-=rgba.g*Math.abs(options.green)),null!=options.blue&&(options.blue>0?rgba.b+=(255-rgba.b)*options.blue:rgba.b-=rgba.b*Math.abs(options.blue)),rgba})}),Filter.register("curves",function(){var bezier,chans,cps,ctrl1,ctrl2,end,i,start,_i,_j,_ref,_ref1;if(chans=arguments[0],cps=2<=arguments.length?__slice.call(arguments,1):[],"string"==typeof chans&&(chans=chans.split("")),"v"===chans[0]&&(chans=["r","g","b"]),cps.length<3||cps.length>4)throw"Invalid number of arguments to curves filter";if(start=cps[0],ctrl1=cps[1],ctrl2=4===cps.length?cps[2]:cps[1],end=cps[cps.length-1],bezier=Calculate.bezier(start,ctrl1,ctrl2,end,0,255),start[0]>0)for(i=_i=0,_ref=start[0];_ref>=0?_ref>_i:_i>_ref;i=_ref>=0?++_i:--_i)bezier[i]=start[1];if(end[0]<255)for(i=_j=_ref1=end[0];255>=_ref1?255>=_j:_j>=255;i=255>=_ref1?++_j:--_j)bezier[i]=end[1];return this.process("curves",function(rgba){var _k,_ref2;for(i=_k=0,_ref2=chans.length;_ref2>=0?_ref2>_k:_k>_ref2;i=_ref2>=0?++_k:--_k)rgba[chans[i]]=bezier[rgba[chans[i]]];return rgba})}),Filter.register("exposure",function(adjust){var ctrl1,ctrl2,p;return p=Math.abs(adjust)/100,ctrl1=[0,255*p],ctrl2=[255-255*p,255],0>adjust&&(ctrl1=ctrl1.reverse(),ctrl2=ctrl2.reverse()),this.curves("rgb",[0,0],ctrl1,ctrl2,[255,255])}),Caman.Plugin.register("crop",function(width,height,x,y){var canvas,ctx;return null==x&&(x=0),null==y&&(y=0),"undefined"!=typeof exports&&null!==exports?canvas=new Canvas(width,height):(canvas=document.createElement("canvas"),Util.copyAttributes(this.canvas,canvas),canvas.width=width,canvas.height=height),ctx=canvas.getContext("2d"),ctx.drawImage(this.canvas,x,y,width,height,0,0,width,height),this.cropCoordinates={x:x,y:y},this.cropped=!0,this.replaceCanvas(canvas)}),Caman.Plugin.register("resize",function(newDims){var canvas,ctx;return null==newDims&&(newDims=null),null===newDims||null==newDims.width&&null==newDims.height?void Log.error("Invalid or missing dimensions given for resize"):(null==newDims.width?newDims.width=this.canvas.width*newDims.height/this.canvas.height:null==newDims.height&&(newDims.height=this.canvas.height*newDims.width/this.canvas.width),"undefined"!=typeof exports&&null!==exports?canvas=new Canvas(newDims.width,newDims.height):(canvas=document.createElement("canvas"),Util.copyAttributes(this.canvas,canvas),canvas.width=newDims.width,canvas.height=newDims.height),ctx=canvas.getContext("2d"),ctx.drawImage(this.canvas,0,0,this.canvas.width,this.canvas.height,0,0,newDims.width,newDims.height),this.resized=!0,this.replaceCanvas(canvas))}),Caman.Filter.register("crop",function(){return this.processPlugin("crop",Array.prototype.slice.call(arguments,0))}),Caman.Filter.register("resize",function(){return this.processPlugin("resize",Array.prototype.slice.call(arguments,0))})}).call(this),function(e,t){function M(e){var t=e.length,n=b.type(e);return b.isWindow(e)?!1:1===e.nodeType&&t?!0:"array"===n||"function"!==n&&(0===t||"number"==typeof t&&t>0&&t-1 in e)}function F(e){var t=_[e]={};return b.each(e.match(w)||[],function(e,n){t[n]=!0}),t}function P(e,n,r,i){if(b.acceptData(e)){var o,a,s=b.expando,u="string"==typeof n,l=e.nodeType,p=l?b.cache:e,f=l?e[s]:e[s]&&s;if(f&&p[f]&&(i||p[f].data)||!u||r!==t)return f||(l?e[s]=f=c.pop()||b.guid++:f=s),p[f]||(p[f]={},l||(p[f].toJSON=b.noop)),("object"==typeof n||"function"==typeof n)&&(i?p[f]=b.extend(p[f],n):p[f].data=b.extend(p[f].data,n)),o=p[f],i||(o.data||(o.data={}),o=o.data),r!==t&&(o[b.camelCase(n)]=r),u?(a=o[n],null==a&&(a=o[b.camelCase(n)])):a=o,a}}function R(e,t,n){if(b.acceptData(e)){var r,i,o,a=e.nodeType,s=a?b.cache:e,u=a?e[b.expando]:b.expando;if(s[u]){if(t&&(o=n?s[u]:s[u].data)){b.isArray(t)?t=t.concat(b.map(t,b.camelCase)):t in o?t=[t]:(t=b.camelCase(t),t=t in o?[t]:t.split(" "));for(r=0,i=t.length;i>r;r++)delete o[t[r]];if(!(n?$:b.isEmptyObject)(o))return}(n||(delete s[u].data,$(s[u])))&&(a?b.cleanData([e],!0):b.support.deleteExpando||s!=s.window?delete s[u]:s[u]=null)}}}function W(e,n,r){if(r===t&&1===e.nodeType){var i="data-"+n.replace(B,"-$1").toLowerCase();if(r=e.getAttribute(i),"string"==typeof r){try{r="true"===r?!0:"false"===r?!1:"null"===r?null:+r+""===r?+r:O.test(r)?b.parseJSON(r):r}catch(o){}b.data(e,n,r)}else r=t}return r}function $(e){var t;for(t in e)if(("data"!==t||!b.isEmptyObject(e[t]))&&"toJSON"!==t)return!1;return!0}function it(){return!0}function ot(){return!1}function pt(e,t){do e=e[t];while(e&&1!==e.nodeType);return e}function ft(e,t,n){if(t=t||0,b.isFunction(t))return b.grep(e,function(e,r){var i=!!t.call(e,r,e);return i===n});if(t.nodeType)return b.grep(e,function(e){return e===t===n});if("string"==typeof t){var r=b.grep(e,function(e){return 1===e.nodeType});if(ut.test(t))return b.filter(t,r,!n);t=b.filter(t,r)}return b.grep(e,function(e){return b.inArray(e,t)>=0===n})}function dt(e){var t=ht.split("|"),n=e.createDocumentFragment();if(n.createElement)for(;t.length;)n.createElement(t.pop());return n}function Lt(e,t){return e.getElementsByTagName(t)[0]||e.appendChild(e.ownerDocument.createElement(t))}function Ht(e){var t=e.getAttributeNode("type");return e.type=(t&&t.specified)+"/"+e.type,e}function qt(e){var t=Et.exec(e.type);return t?e.type=t[1]:e.removeAttribute("type"),e}function Mt(e,t){for(var n,r=0;null!=(n=e[r]);r++)b._data(n,"globalEval",!t||b._data(t[r],"globalEval"))}function _t(e,t){if(1===t.nodeType&&b.hasData(e)){var n,r,i,o=b._data(e),a=b._data(t,o),s=o.events;if(s){delete a.handle,a.events={};for(n in s)for(r=0,i=s[n].length;i>r;r++)b.event.add(t,n,s[n][r])}a.data&&(a.data=b.extend({},a.data))}}function Ft(e,t){var n,r,i;if(1===t.nodeType){if(n=t.nodeName.toLowerCase(),!b.support.noCloneEvent&&t[b.expando]){i=b._data(t);for(r in i.events)b.removeEvent(t,r,i.handle);t.removeAttribute(b.expando)}"script"===n&&t.text!==e.text?(Ht(t).text=e.text,qt(t)):"object"===n?(t.parentNode&&(t.outerHTML=e.outerHTML),b.support.html5Clone&&e.innerHTML&&!b.trim(t.innerHTML)&&(t.innerHTML=e.innerHTML)):"input"===n&&Nt.test(e.type)?(t.defaultChecked=t.checked=e.checked,t.value!==e.value&&(t.value=e.value)):"option"===n?t.defaultSelected=t.selected=e.defaultSelected:("input"===n||"textarea"===n)&&(t.defaultValue=e.defaultValue)}}function Ot(e,n){var r,o,a=0,s=typeof e.getElementsByTagName!==i?e.getElementsByTagName(n||"*"):typeof e.querySelectorAll!==i?e.querySelectorAll(n||"*"):t;if(!s)for(s=[],r=e.childNodes||e;null!=(o=r[a]);a++)!n||b.nodeName(o,n)?s.push(o):b.merge(s,Ot(o,n));return n===t||n&&b.nodeName(e,n)?b.merge([e],s):s}function Bt(e){Nt.test(e.type)&&(e.defaultChecked=e.checked)}function tn(e,t){if(t in e)return t;for(var n=t.charAt(0).toUpperCase()+t.slice(1),r=t,i=en.length;i--;)if(t=en[i]+n,t in e)return t;return r}function nn(e,t){return e=t||e,"none"===b.css(e,"display")||!b.contains(e.ownerDocument,e)}function rn(e,t){for(var n,r,i,o=[],a=0,s=e.length;s>a;a++)r=e[a],r.style&&(o[a]=b._data(r,"olddisplay"),n=r.style.display,t?(o[a]||"none"!==n||(r.style.display=""),""===r.style.display&&nn(r)&&(o[a]=b._data(r,"olddisplay",un(r.nodeName)))):o[a]||(i=nn(r),(n&&"none"!==n||!i)&&b._data(r,"olddisplay",i?n:b.css(r,"display"))));for(a=0;s>a;a++)r=e[a],r.style&&(t&&"none"!==r.style.display&&""!==r.style.display||(r.style.display=t?o[a]||"":"none"));return e}function on(e,t,n){var r=Vt.exec(t);return r?Math.max(0,r[1]-(n||0))+(r[2]||"px"):t}function an(e,t,n,r,i){for(var o=n===(r?"border":"content")?4:"width"===t?1:0,a=0;4>o;o+=2)"margin"===n&&(a+=b.css(e,n+Zt[o],!0,i)),r?("content"===n&&(a-=b.css(e,"padding"+Zt[o],!0,i)),"margin"!==n&&(a-=b.css(e,"border"+Zt[o]+"Width",!0,i))):(a+=b.css(e,"padding"+Zt[o],!0,i),"padding"!==n&&(a+=b.css(e,"border"+Zt[o]+"Width",!0,i)));return a}function sn(e,t,n){var r=!0,i="width"===t?e.offsetWidth:e.offsetHeight,o=Rt(e),a=b.support.boxSizing&&"border-box"===b.css(e,"boxSizing",!1,o);if(0>=i||null==i){if(i=Wt(e,t,o),(0>i||null==i)&&(i=e.style[t]),Yt.test(i))return i;r=a&&(b.support.boxSizingReliable||i===e.style[t]),i=parseFloat(i)||0}return i+an(e,t,n||(a?"border":"content"),r,o)+"px"}function un(e){var t=o,n=Gt[e];return n||(n=ln(e,t),"none"!==n&&n||(Pt=(Pt||b("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(t.documentElement),t=(Pt[0].contentWindow||Pt[0].contentDocument).document,t.write("<!doctype html><html><body>"),t.close(),n=ln(e,t),Pt.detach()),Gt[e]=n),n}function ln(e,t){var n=b(t.createElement(e)).appendTo(t.body),r=b.css(n[0],"display");return n.remove(),r}function gn(e,t,n,r){var i;if(b.isArray(t))b.each(t,function(t,i){n||pn.test(e)?r(e,i):gn(e+"["+("object"==typeof i?t:"")+"]",i,n,r)});else if(n||"object"!==b.type(t))r(e,t);else for(i in t)gn(e+"["+i+"]",t[i],n,r)}function Hn(e){return function(t,n){"string"!=typeof t&&(n=t,t="*");var r,i=0,o=t.toLowerCase().match(w)||[];if(b.isFunction(n))for(;r=o[i++];)"+"===r[0]?(r=r.slice(1)||"*",(e[r]=e[r]||[]).unshift(n)):(e[r]=e[r]||[]).push(n)}}function qn(e,n,r,i){function s(u){var l;return o[u]=!0,b.each(e[u]||[],function(e,u){var c=u(n,r,i);return"string"!=typeof c||a||o[c]?a?!(l=c):t:(n.dataTypes.unshift(c),s(c),!1)}),l}var o={},a=e===jn;return s(n.dataTypes[0])||!o["*"]&&s("*")}function Mn(e,n){var r,i,o=b.ajaxSettings.flatOptions||{};for(i in n)n[i]!==t&&((o[i]?e:r||(r={}))[i]=n[i]);return r&&b.extend(!0,e,r),e}function _n(e,n,r){var i,o,a,s,u=e.contents,l=e.dataTypes,c=e.responseFields;for(s in c)s in r&&(n[c[s]]=r[s]);for(;"*"===l[0];)l.shift(),o===t&&(o=e.mimeType||n.getResponseHeader("Content-Type"));if(o)for(s in u)if(u[s]&&u[s].test(o)){l.unshift(s);break}if(l[0]in r)a=l[0];else{for(s in r){if(!l[0]||e.converters[s+" "+l[0]]){a=s;break}i||(i=s)}a=a||i}return a?(a!==l[0]&&l.unshift(a),r[a]):t}function Fn(e,t){var n,r,i,o,a={},s=0,u=e.dataTypes.slice(),l=u[0];if(e.dataFilter&&(t=e.dataFilter(t,e.dataType)),u[1])for(i in e.converters)a[i.toLowerCase()]=e.converters[i];for(;r=u[++s];)if("*"!==r){if("*"!==l&&l!==r){if(i=a[l+" "+r]||a["* "+r],!i)for(n in a)if(o=n.split(" "),o[1]===r&&(i=a[l+" "+o[0]]||a["* "+o[0]])){i===!0?i=a[n]:a[n]!==!0&&(r=o[0],u.splice(s--,0,r));break}if(i!==!0)if(i&&e["throws"])t=i(t);else try{t=i(t)}catch(c){return{state:"parsererror",error:i?c:"No conversion from "+l+" to "+r}}}l=r}return{state:"success",data:t}}function In(){try{return new e.XMLHttpRequest}catch(t){}}function zn(){try{return new e.ActiveXObject("Microsoft.XMLHTTP")}catch(t){}}function Kn(){return setTimeout(function(){Xn=t}),Xn=b.now()}function Zn(e,t){b.each(t,function(t,n){for(var r=(Qn[t]||[]).concat(Qn["*"]),i=0,o=r.length;o>i;i++)if(r[i].call(e,t,n))return})}function er(e,t,n){var r,i,o=0,a=Gn.length,s=b.Deferred().always(function(){delete u.elem}),u=function(){if(i)return!1;for(var t=Xn||Kn(),n=Math.max(0,l.startTime+l.duration-t),r=n/l.duration||0,o=1-r,a=0,u=l.tweens.length;u>a;a++)l.tweens[a].run(o);return s.notifyWith(e,[l,o,n]),1>o&&u?n:(s.resolveWith(e,[l]),!1)},l=s.promise({elem:e,props:b.extend({},t),opts:b.extend(!0,{specialEasing:{}},n),originalProperties:t,originalOptions:n,startTime:Xn||Kn(),duration:n.duration,tweens:[],createTween:function(t,n){var r=b.Tween(e,l.opts,t,n,l.opts.specialEasing[t]||l.opts.easing);return l.tweens.push(r),r},stop:function(t){var n=0,r=t?l.tweens.length:0;if(i)return this;for(i=!0;r>n;n++)l.tweens[n].run(1);return t?s.resolveWith(e,[l,t]):s.rejectWith(e,[l,t]),this}}),c=l.props;for(tr(c,l.opts.specialEasing);a>o;o++)if(r=Gn[o].call(l,e,c,l.opts))return r;return Zn(l,c),b.isFunction(l.opts.start)&&l.opts.start.call(e,l),b.fx.timer(b.extend(u,{elem:e,anim:l,queue:l.opts.queue})),l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always)}function tr(e,t){var n,r,i,o,a;for(i in e)if(r=b.camelCase(i),o=t[r],n=e[i],b.isArray(n)&&(o=n[1],n=e[i]=n[0]),i!==r&&(e[r]=n,delete e[i]),a=b.cssHooks[r],a&&"expand"in a){n=a.expand(n),delete e[r];for(i in n)i in e||(e[i]=n[i],t[i]=o)}else t[r]=o}function nr(e,t,n){var r,i,o,a,s,u,l,c,p,f=this,d=e.style,h={},g=[],m=e.nodeType&&nn(e);n.queue||(c=b._queueHooks(e,"fx"),null==c.unqueued&&(c.unqueued=0,p=c.empty.fire,c.empty.fire=function(){c.unqueued||p()}),c.unqueued++,f.always(function(){f.always(function(){c.unqueued--,b.queue(e,"fx").length||c.empty.fire()})})),1===e.nodeType&&("height"in t||"width"in t)&&(n.overflow=[d.overflow,d.overflowX,d.overflowY],"inline"===b.css(e,"display")&&"none"===b.css(e,"float")&&(b.support.inlineBlockNeedsLayout&&"inline"!==un(e.nodeName)?d.zoom=1:d.display="inline-block")),n.overflow&&(d.overflow="hidden",b.support.shrinkWrapBlocks||f.always(function(){d.overflow=n.overflow[0],d.overflowX=n.overflow[1],d.overflowY=n.overflow[2]}));for(i in t)if(a=t[i],Vn.exec(a)){if(delete t[i],u=u||"toggle"===a,a===(m?"hide":"show"))continue;g.push(i)}if(o=g.length){s=b._data(e,"fxshow")||b._data(e,"fxshow",{}),"hidden"in s&&(m=s.hidden),u&&(s.hidden=!m),m?b(e).show():f.done(function(){b(e).hide()}),f.done(function(){var t;b._removeData(e,"fxshow");for(t in h)b.style(e,t,h[t])});for(i=0;o>i;i++)r=g[i],l=f.createTween(r,m?s[r]:0),h[r]=s[r]||b.style(e,r),r in s||(s[r]=l.start,m&&(l.end=l.start,l.start="width"===r||"height"===r?1:0))}}function rr(e,t,n,r,i){return new rr.prototype.init(e,t,n,r,i)}function ir(e,t){var n,r={height:e},i=0;for(t=t?1:0;4>i;i+=2-t)n=Zt[i],r["margin"+n]=r["padding"+n]=e;return t&&(r.opacity=r.width=e),r}function or(e){return b.isWindow(e)?e:9===e.nodeType?e.defaultView||e.parentWindow:!1}var n,r,i=typeof t,o=e.document,a=e.location,s=e.jQuery,u=e.$,l={},c=[],p="1.9.1",f=c.concat,d=c.push,h=c.slice,g=c.indexOf,m=l.toString,y=l.hasOwnProperty,v=p.trim,b=function(e,t){return new b.fn.init(e,t,r)},x=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,w=/\S+/g,T=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,N=/^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,C=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,k=/^[\],:{}\s]*$/,E=/(?:^|:|,)(?:\s*\[)+/g,S=/\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,A=/"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,j=/^-ms-/,D=/-([\da-z])/gi,L=function(e,t){return t.toUpperCase()},H=function(e){(o.addEventListener||"load"===e.type||"complete"===o.readyState)&&(q(),b.ready())},q=function(){o.addEventListener?(o.removeEventListener("DOMContentLoaded",H,!1),e.removeEventListener("load",H,!1)):(o.detachEvent("onreadystatechange",H),e.detachEvent("onload",H))};b.fn=b.prototype={jquery:p,constructor:b,init:function(e,n,r){var i,a;if(!e)return this;if("string"==typeof e){if(i="<"===e.charAt(0)&&">"===e.charAt(e.length-1)&&e.length>=3?[null,e,null]:N.exec(e),!i||!i[1]&&n)return!n||n.jquery?(n||r).find(e):this.constructor(n).find(e);if(i[1]){if(n=n instanceof b?n[0]:n,b.merge(this,b.parseHTML(i[1],n&&n.nodeType?n.ownerDocument||n:o,!0)),C.test(i[1])&&b.isPlainObject(n))for(i in n)b.isFunction(this[i])?this[i](n[i]):this.attr(i,n[i]);return this}if(a=o.getElementById(i[2]),a&&a.parentNode){if(a.id!==i[2])return r.find(e);this.length=1,this[0]=a}return this.context=o,this.selector=e,this}return e.nodeType?(this.context=this[0]=e,this.length=1,this):b.isFunction(e)?r.ready(e):(e.selector!==t&&(this.selector=e.selector,this.context=e.context),b.makeArray(e,this))},selector:"",length:0,size:function(){return this.length},toArray:function(){return h.call(this)},get:function(e){return null==e?this.toArray():0>e?this[this.length+e]:this[e]},pushStack:function(e){var t=b.merge(this.constructor(),e);return t.prevObject=this,t.context=this.context,t},each:function(e,t){return b.each(this,e,t)},ready:function(e){return b.ready.promise().done(e),this},slice:function(){return this.pushStack(h.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(e){var t=this.length,n=+e+(0>e?t:0);return this.pushStack(n>=0&&t>n?[this[n]]:[])},map:function(e){return this.pushStack(b.map(this,function(t,n){return e.call(t,n,t)}))},end:function(){return this.prevObject||this.constructor(null)},push:d,sort:[].sort,splice:[].splice},b.fn.init.prototype=b.fn,b.extend=b.fn.extend=function(){var e,n,r,i,o,a,s=arguments[0]||{},u=1,l=arguments.length,c=!1;for("boolean"==typeof s&&(c=s,s=arguments[1]||{},u=2),"object"==typeof s||b.isFunction(s)||(s={}),l===u&&(s=this,--u);l>u;u++)if(null!=(o=arguments[u]))for(i in o)e=s[i],r=o[i],s!==r&&(c&&r&&(b.isPlainObject(r)||(n=b.isArray(r)))?(n?(n=!1,a=e&&b.isArray(e)?e:[]):a=e&&b.isPlainObject(e)?e:{},s[i]=b.extend(c,a,r)):r!==t&&(s[i]=r));return s},b.extend({noConflict:function(t){return e.$===b&&(e.$=u),t&&e.jQuery===b&&(e.jQuery=s),b},isReady:!1,readyWait:1,holdReady:function(e){e?b.readyWait++:b.ready(!0)},ready:function(e){if(e===!0?!--b.readyWait:!b.isReady){if(!o.body)return setTimeout(b.ready);b.isReady=!0,e!==!0&&--b.readyWait>0||(n.resolveWith(o,[b]),b.fn.trigger&&b(o).trigger("ready").off("ready"))}},isFunction:function(e){return"function"===b.type(e)},isArray:Array.isArray||function(e){return"array"===b.type(e)},isWindow:function(e){return null!=e&&e==e.window},isNumeric:function(e){return!isNaN(parseFloat(e))&&isFinite(e)},type:function(e){return null==e?e+"":"object"==typeof e||"function"==typeof e?l[m.call(e)]||"object":typeof e},isPlainObject:function(e){if(!e||"object"!==b.type(e)||e.nodeType||b.isWindow(e))return!1;try{if(e.constructor&&!y.call(e,"constructor")&&!y.call(e.constructor.prototype,"isPrototypeOf"))return!1}catch(n){return!1}var r;for(r in e);return r===t||y.call(e,r)},isEmptyObject:function(e){var t;for(t in e)return!1;return!0},error:function(e){throw Error(e)},parseHTML:function(e,t,n){if(!e||"string"!=typeof e)return null;"boolean"==typeof t&&(n=t,t=!1),t=t||o;var r=C.exec(e),i=!n&&[];return r?[t.createElement(r[1])]:(r=b.buildFragment([e],t,i),i&&b(i).remove(),b.merge([],r.childNodes))},parseJSON:function(n){return e.JSON&&e.JSON.parse?e.JSON.parse(n):null===n?n:"string"==typeof n&&(n=b.trim(n),n&&k.test(n.replace(S,"@").replace(A,"]").replace(E,"")))?Function("return "+n)():(b.error("Invalid JSON: "+n),t)},parseXML:function(n){var r,i;if(!n||"string"!=typeof n)return null;try{e.DOMParser?(i=new DOMParser,r=i.parseFromString(n,"text/xml")):(r=new ActiveXObject("Microsoft.XMLDOM"),r.async="false",r.loadXML(n))}catch(o){r=t}return r&&r.documentElement&&!r.getElementsByTagName("parsererror").length||b.error("Invalid XML: "+n),r},noop:function(){},globalEval:function(t){t&&b.trim(t)&&(e.execScript||function(t){e.eval.call(e,t)})(t)},camelCase:function(e){return e.replace(j,"ms-").replace(D,L)},nodeName:function(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()},each:function(e,t,n){var r,i=0,o=e.length,a=M(e);if(n){if(a)for(;o>i&&(r=t.apply(e[i],n),r!==!1);i++);else for(i in e)if(r=t.apply(e[i],n),r===!1)break}else if(a)for(;o>i&&(r=t.call(e[i],i,e[i]),r!==!1);i++);else for(i in e)if(r=t.call(e[i],i,e[i]),r===!1)break;return e},trim:v&&!v.call("﻿ ")?function(e){return null==e?"":v.call(e)}:function(e){return null==e?"":(e+"").replace(T,"")},makeArray:function(e,t){var n=t||[];return null!=e&&(M(Object(e))?b.merge(n,"string"==typeof e?[e]:e):d.call(n,e)),n},inArray:function(e,t,n){var r;if(t){if(g)return g.call(t,e,n);for(r=t.length,n=n?0>n?Math.max(0,r+n):n:0;r>n;n++)if(n in t&&t[n]===e)return n}return-1},merge:function(e,n){var r=n.length,i=e.length,o=0;if("number"==typeof r)for(;r>o;o++)e[i++]=n[o];else for(;n[o]!==t;)e[i++]=n[o++];return e.length=i,e},grep:function(e,t,n){var r,i=[],o=0,a=e.length;for(n=!!n;a>o;o++)r=!!t(e[o],o),n!==r&&i.push(e[o]);return i},map:function(e,t,n){var r,i=0,o=e.length,a=M(e),s=[];if(a)for(;o>i;i++)r=t(e[i],i,n),null!=r&&(s[s.length]=r);else for(i in e)r=t(e[i],i,n),null!=r&&(s[s.length]=r);return f.apply([],s)},guid:1,proxy:function(e,n){var r,i,o;return"string"==typeof n&&(o=e[n],n=e,e=o),b.isFunction(e)?(r=h.call(arguments,2),i=function(){return e.apply(n||this,r.concat(h.call(arguments)))},i.guid=e.guid=e.guid||b.guid++,i):t},access:function(e,n,r,i,o,a,s){var u=0,l=e.length,c=null==r;if("object"===b.type(r)){o=!0;for(u in r)b.access(e,n,u,r[u],!0,a,s)}else if(i!==t&&(o=!0,b.isFunction(i)||(s=!0),c&&(s?(n.call(e,i),n=null):(c=n,n=function(e,t,n){return c.call(b(e),n)})),n))for(;l>u;u++)n(e[u],r,s?i:i.call(e[u],u,n(e[u],r)));return o?e:c?n.call(e):l?n(e[0],r):a},now:function(){return(new Date).getTime()}}),b.ready.promise=function(t){if(!n)if(n=b.Deferred(),"complete"===o.readyState)setTimeout(b.ready);else if(o.addEventListener)o.addEventListener("DOMContentLoaded",H,!1),e.addEventListener("load",H,!1);else{o.attachEvent("onreadystatechange",H),e.attachEvent("onload",H);var r=!1;try{r=null==e.frameElement&&o.documentElement}catch(i){}r&&r.doScroll&&function a(){if(!b.isReady){try{r.doScroll("left")}catch(e){return setTimeout(a,50)}q(),b.ready()}}()}return n.promise(t)},b.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(e,t){l["[object "+t+"]"]=t.toLowerCase()}),r=b(o);var _={};b.Callbacks=function(e){e="string"==typeof e?_[e]||F(e):b.extend({},e);var n,r,i,o,a,s,u=[],l=!e.once&&[],c=function(t){for(r=e.memory&&t,i=!0,a=s||0,s=0,o=u.length,n=!0;u&&o>a;a++)if(u[a].apply(t[0],t[1])===!1&&e.stopOnFalse){r=!1;break}n=!1,u&&(l?l.length&&c(l.shift()):r?u=[]:p.disable())},p={add:function(){if(u){var t=u.length;!function i(t){b.each(t,function(t,n){var r=b.type(n);"function"===r?e.unique&&p.has(n)||u.push(n):n&&n.length&&"string"!==r&&i(n)})}(arguments),n?o=u.length:r&&(s=t,c(r))}return this},remove:function(){return u&&b.each(arguments,function(e,t){for(var r;(r=b.inArray(t,u,r))>-1;)u.splice(r,1),n&&(o>=r&&o--,a>=r&&a--)
}),this},has:function(e){return e?b.inArray(e,u)>-1:!(!u||!u.length)},empty:function(){return u=[],this},disable:function(){return u=l=r=t,this},disabled:function(){return!u},lock:function(){return l=t,r||p.disable(),this},locked:function(){return!l},fireWith:function(e,t){return t=t||[],t=[e,t.slice?t.slice():t],!u||i&&!l||(n?l.push(t):c(t)),this},fire:function(){return p.fireWith(this,arguments),this},fired:function(){return!!i}};return p},b.extend({Deferred:function(e){var t=[["resolve","done",b.Callbacks("once memory"),"resolved"],["reject","fail",b.Callbacks("once memory"),"rejected"],["notify","progress",b.Callbacks("memory")]],n="pending",r={state:function(){return n},always:function(){return i.done(arguments).fail(arguments),this},then:function(){var e=arguments;return b.Deferred(function(n){b.each(t,function(t,o){var a=o[0],s=b.isFunction(e[t])&&e[t];i[o[1]](function(){var e=s&&s.apply(this,arguments);e&&b.isFunction(e.promise)?e.promise().done(n.resolve).fail(n.reject).progress(n.notify):n[a+"With"](this===r?n.promise():this,s?[e]:arguments)})}),e=null}).promise()},promise:function(e){return null!=e?b.extend(e,r):r}},i={};return r.pipe=r.then,b.each(t,function(e,o){var a=o[2],s=o[3];r[o[1]]=a.add,s&&a.add(function(){n=s},t[1^e][2].disable,t[2][2].lock),i[o[0]]=function(){return i[o[0]+"With"](this===i?r:this,arguments),this},i[o[0]+"With"]=a.fireWith}),r.promise(i),e&&e.call(i,i),i},when:function(e){var s,u,l,t=0,n=h.call(arguments),r=n.length,i=1!==r||e&&b.isFunction(e.promise)?r:0,o=1===i?e:b.Deferred(),a=function(e,t,n){return function(r){t[e]=this,n[e]=arguments.length>1?h.call(arguments):r,n===s?o.notifyWith(t,n):--i||o.resolveWith(t,n)}};if(r>1)for(s=Array(r),u=Array(r),l=Array(r);r>t;t++)n[t]&&b.isFunction(n[t].promise)?n[t].promise().done(a(t,l,n)).fail(o.reject).progress(a(t,u,s)):--i;return i||o.resolveWith(l,n),o.promise()}}),b.support=function(){var t,n,r,a,s,u,l,c,p,f,d=o.createElement("div");if(d.setAttribute("className","t"),d.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",n=d.getElementsByTagName("*"),r=d.getElementsByTagName("a")[0],!n||!r||!n.length)return{};s=o.createElement("select"),l=s.appendChild(o.createElement("option")),a=d.getElementsByTagName("input")[0],r.style.cssText="top:1px;float:left;opacity:.5",t={getSetAttribute:"t"!==d.className,leadingWhitespace:3===d.firstChild.nodeType,tbody:!d.getElementsByTagName("tbody").length,htmlSerialize:!!d.getElementsByTagName("link").length,style:/top/.test(r.getAttribute("style")),hrefNormalized:"/a"===r.getAttribute("href"),opacity:/^0.5/.test(r.style.opacity),cssFloat:!!r.style.cssFloat,checkOn:!!a.value,optSelected:l.selected,enctype:!!o.createElement("form").enctype,html5Clone:"<:nav></:nav>"!==o.createElement("nav").cloneNode(!0).outerHTML,boxModel:"CSS1Compat"===o.compatMode,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0,boxSizingReliable:!0,pixelPosition:!1},a.checked=!0,t.noCloneChecked=a.cloneNode(!0).checked,s.disabled=!0,t.optDisabled=!l.disabled;try{delete d.test}catch(h){t.deleteExpando=!1}a=o.createElement("input"),a.setAttribute("value",""),t.input=""===a.getAttribute("value"),a.value="t",a.setAttribute("type","radio"),t.radioValue="t"===a.value,a.setAttribute("checked","t"),a.setAttribute("name","t"),u=o.createDocumentFragment(),u.appendChild(a),t.appendChecked=a.checked,t.checkClone=u.cloneNode(!0).cloneNode(!0).lastChild.checked,d.attachEvent&&(d.attachEvent("onclick",function(){t.noCloneEvent=!1}),d.cloneNode(!0).click());for(f in{submit:!0,change:!0,focusin:!0})d.setAttribute(c="on"+f,"t"),t[f+"Bubbles"]=c in e||d.attributes[c].expando===!1;return d.style.backgroundClip="content-box",d.cloneNode(!0).style.backgroundClip="",t.clearCloneStyle="content-box"===d.style.backgroundClip,b(function(){var n,r,a,s="padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;",u=o.getElementsByTagName("body")[0];u&&(n=o.createElement("div"),n.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",u.appendChild(n).appendChild(d),d.innerHTML="<table><tr><td></td><td>t</td></tr></table>",a=d.getElementsByTagName("td"),a[0].style.cssText="padding:0;margin:0;border:0;display:none",p=0===a[0].offsetHeight,a[0].style.display="",a[1].style.display="none",t.reliableHiddenOffsets=p&&0===a[0].offsetHeight,d.innerHTML="",d.style.cssText="box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;",t.boxSizing=4===d.offsetWidth,t.doesNotIncludeMarginInBodyOffset=1!==u.offsetTop,e.getComputedStyle&&(t.pixelPosition="1%"!==(e.getComputedStyle(d,null)||{}).top,t.boxSizingReliable="4px"===(e.getComputedStyle(d,null)||{width:"4px"}).width,r=d.appendChild(o.createElement("div")),r.style.cssText=d.style.cssText=s,r.style.marginRight=r.style.width="0",d.style.width="1px",t.reliableMarginRight=!parseFloat((e.getComputedStyle(r,null)||{}).marginRight)),typeof d.style.zoom!==i&&(d.innerHTML="",d.style.cssText=s+"width:1px;padding:1px;display:inline;zoom:1",t.inlineBlockNeedsLayout=3===d.offsetWidth,d.style.display="block",d.innerHTML="<div></div>",d.firstChild.style.width="5px",t.shrinkWrapBlocks=3!==d.offsetWidth,t.inlineBlockNeedsLayout&&(u.style.zoom=1)),u.removeChild(n),n=d=a=r=null)}),n=s=u=l=r=a=null,t}();var O=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,B=/([A-Z])/g;b.extend({cache:{},expando:"jQuery"+(p+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(e){return e=e.nodeType?b.cache[e[b.expando]]:e[b.expando],!!e&&!$(e)},data:function(e,t,n){return P(e,t,n)},removeData:function(e,t){return R(e,t)},_data:function(e,t,n){return P(e,t,n,!0)},_removeData:function(e,t){return R(e,t,!0)},acceptData:function(e){if(e.nodeType&&1!==e.nodeType&&9!==e.nodeType)return!1;var t=e.nodeName&&b.noData[e.nodeName.toLowerCase()];return!t||t!==!0&&e.getAttribute("classid")===t}}),b.fn.extend({data:function(e,n){var r,i,o=this[0],a=0,s=null;if(e===t){if(this.length&&(s=b.data(o),1===o.nodeType&&!b._data(o,"parsedAttrs"))){for(r=o.attributes;r.length>a;a++)i=r[a].name,i.indexOf("data-")||(i=b.camelCase(i.slice(5)),W(o,i,s[i]));b._data(o,"parsedAttrs",!0)}return s}return"object"==typeof e?this.each(function(){b.data(this,e)}):b.access(this,function(n){return n===t?o?W(o,e,b.data(o,e)):null:(this.each(function(){b.data(this,e,n)}),t)},null,n,arguments.length>1,null,!0)},removeData:function(e){return this.each(function(){b.removeData(this,e)})}}),b.extend({queue:function(e,n,r){var i;return e?(n=(n||"fx")+"queue",i=b._data(e,n),r&&(!i||b.isArray(r)?i=b._data(e,n,b.makeArray(r)):i.push(r)),i||[]):t},dequeue:function(e,t){t=t||"fx";var n=b.queue(e,t),r=n.length,i=n.shift(),o=b._queueHooks(e,t),a=function(){b.dequeue(e,t)};"inprogress"===i&&(i=n.shift(),r--),o.cur=i,i&&("fx"===t&&n.unshift("inprogress"),delete o.stop,i.call(e,a,o)),!r&&o&&o.empty.fire()},_queueHooks:function(e,t){var n=t+"queueHooks";return b._data(e,n)||b._data(e,n,{empty:b.Callbacks("once memory").add(function(){b._removeData(e,t+"queue"),b._removeData(e,n)})})}}),b.fn.extend({queue:function(e,n){var r=2;return"string"!=typeof e&&(n=e,e="fx",r--),r>arguments.length?b.queue(this[0],e):n===t?this:this.each(function(){var t=b.queue(this,e,n);b._queueHooks(this,e),"fx"===e&&"inprogress"!==t[0]&&b.dequeue(this,e)})},dequeue:function(e){return this.each(function(){b.dequeue(this,e)})},delay:function(e,t){return e=b.fx?b.fx.speeds[e]||e:e,t=t||"fx",this.queue(t,function(t,n){var r=setTimeout(t,e);n.stop=function(){clearTimeout(r)}})},clearQueue:function(e){return this.queue(e||"fx",[])},promise:function(e,n){var r,i=1,o=b.Deferred(),a=this,s=this.length,u=function(){--i||o.resolveWith(a,[a])};for("string"!=typeof e&&(n=e,e=t),e=e||"fx";s--;)r=b._data(a[s],e+"queueHooks"),r&&r.empty&&(i++,r.empty.add(u));return u(),o.promise(n)}});var I,z,X=/[\t\r\n]/g,U=/\r/g,V=/^(?:input|select|textarea|button|object)$/i,Y=/^(?:a|area)$/i,J=/^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,G=/^(?:checked|selected)$/i,Q=b.support.getSetAttribute,K=b.support.input;b.fn.extend({attr:function(e,t){return b.access(this,b.attr,e,t,arguments.length>1)},removeAttr:function(e){return this.each(function(){b.removeAttr(this,e)})},prop:function(e,t){return b.access(this,b.prop,e,t,arguments.length>1)},removeProp:function(e){return e=b.propFix[e]||e,this.each(function(){try{this[e]=t,delete this[e]}catch(n){}})},addClass:function(e){var t,n,r,i,o,a=0,s=this.length,u="string"==typeof e&&e;if(b.isFunction(e))return this.each(function(t){b(this).addClass(e.call(this,t,this.className))});if(u)for(t=(e||"").match(w)||[];s>a;a++)if(n=this[a],r=1===n.nodeType&&(n.className?(" "+n.className+" ").replace(X," "):" ")){for(o=0;i=t[o++];)0>r.indexOf(" "+i+" ")&&(r+=i+" ");n.className=b.trim(r)}return this},removeClass:function(e){var t,n,r,i,o,a=0,s=this.length,u=0===arguments.length||"string"==typeof e&&e;if(b.isFunction(e))return this.each(function(t){b(this).removeClass(e.call(this,t,this.className))});if(u)for(t=(e||"").match(w)||[];s>a;a++)if(n=this[a],r=1===n.nodeType&&(n.className?(" "+n.className+" ").replace(X," "):"")){for(o=0;i=t[o++];)for(;r.indexOf(" "+i+" ")>=0;)r=r.replace(" "+i+" "," ");n.className=e?b.trim(r):""}return this},toggleClass:function(e,t){var n=typeof e,r="boolean"==typeof t;return this.each(b.isFunction(e)?function(n){b(this).toggleClass(e.call(this,n,this.className,t),t)}:function(){if("string"===n)for(var o,a=0,s=b(this),u=t,l=e.match(w)||[];o=l[a++];)u=r?u:!s.hasClass(o),s[u?"addClass":"removeClass"](o);else(n===i||"boolean"===n)&&(this.className&&b._data(this,"__className__",this.className),this.className=this.className||e===!1?"":b._data(this,"__className__")||"")})},hasClass:function(e){for(var t=" "+e+" ",n=0,r=this.length;r>n;n++)if(1===this[n].nodeType&&(" "+this[n].className+" ").replace(X," ").indexOf(t)>=0)return!0;return!1},val:function(e){var n,r,i,o=this[0];return arguments.length?(i=b.isFunction(e),this.each(function(n){var o,a=b(this);1===this.nodeType&&(o=i?e.call(this,n,a.val()):e,null==o?o="":"number"==typeof o?o+="":b.isArray(o)&&(o=b.map(o,function(e){return null==e?"":e+""})),r=b.valHooks[this.type]||b.valHooks[this.nodeName.toLowerCase()],r&&"set"in r&&r.set(this,o,"value")!==t||(this.value=o))})):o?(r=b.valHooks[o.type]||b.valHooks[o.nodeName.toLowerCase()],r&&"get"in r&&(n=r.get(o,"value"))!==t?n:(n=o.value,"string"==typeof n?n.replace(U,""):null==n?"":n)):void 0}}),b.extend({valHooks:{option:{get:function(e){var t=e.attributes.value;return!t||t.specified?e.value:e.text}},select:{get:function(e){for(var t,n,r=e.options,i=e.selectedIndex,o="select-one"===e.type||0>i,a=o?null:[],s=o?i+1:r.length,u=0>i?s:o?i:0;s>u;u++)if(n=r[u],!(!n.selected&&u!==i||(b.support.optDisabled?n.disabled:null!==n.getAttribute("disabled"))||n.parentNode.disabled&&b.nodeName(n.parentNode,"optgroup"))){if(t=b(n).val(),o)return t;a.push(t)}return a},set:function(e,t){var n=b.makeArray(t);return b(e).find("option").each(function(){this.selected=b.inArray(b(this).val(),n)>=0}),n.length||(e.selectedIndex=-1),n}}},attr:function(e,n,r){var o,a,s,u=e.nodeType;return e&&3!==u&&8!==u&&2!==u?typeof e.getAttribute===i?b.prop(e,n,r):(a=1!==u||!b.isXMLDoc(e),a&&(n=n.toLowerCase(),o=b.attrHooks[n]||(J.test(n)?z:I)),r===t?o&&a&&"get"in o&&null!==(s=o.get(e,n))?s:(typeof e.getAttribute!==i&&(s=e.getAttribute(n)),null==s?t:s):null!==r?o&&a&&"set"in o&&(s=o.set(e,r,n))!==t?s:(e.setAttribute(n,r+""),r):(b.removeAttr(e,n),t)):void 0},removeAttr:function(e,t){var n,r,i=0,o=t&&t.match(w);if(o&&1===e.nodeType)for(;n=o[i++];)r=b.propFix[n]||n,J.test(n)?!Q&&G.test(n)?e[b.camelCase("default-"+n)]=e[r]=!1:e[r]=!1:b.attr(e,n,""),e.removeAttribute(Q?n:r)},attrHooks:{type:{set:function(e,t){if(!b.support.radioValue&&"radio"===t&&b.nodeName(e,"input")){var n=e.value;return e.setAttribute("type",t),n&&(e.value=n),t}}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(e,n,r){var i,o,a,s=e.nodeType;return e&&3!==s&&8!==s&&2!==s?(a=1!==s||!b.isXMLDoc(e),a&&(n=b.propFix[n]||n,o=b.propHooks[n]),r!==t?o&&"set"in o&&(i=o.set(e,r,n))!==t?i:e[n]=r:o&&"get"in o&&null!==(i=o.get(e,n))?i:e[n]):void 0},propHooks:{tabIndex:{get:function(e){var n=e.getAttributeNode("tabindex");return n&&n.specified?parseInt(n.value,10):V.test(e.nodeName)||Y.test(e.nodeName)&&e.href?0:t}}}}),z={get:function(e,n){var r=b.prop(e,n),i="boolean"==typeof r&&e.getAttribute(n),o="boolean"==typeof r?K&&Q?null!=i:G.test(n)?e[b.camelCase("default-"+n)]:!!i:e.getAttributeNode(n);return o&&o.value!==!1?n.toLowerCase():t},set:function(e,t,n){return t===!1?b.removeAttr(e,n):K&&Q||!G.test(n)?e.setAttribute(!Q&&b.propFix[n]||n,n):e[b.camelCase("default-"+n)]=e[n]=!0,n}},K&&Q||(b.attrHooks.value={get:function(e,n){var r=e.getAttributeNode(n);return b.nodeName(e,"input")?e.defaultValue:r&&r.specified?r.value:t},set:function(e,n,r){return b.nodeName(e,"input")?(e.defaultValue=n,t):I&&I.set(e,n,r)}}),Q||(I=b.valHooks.button={get:function(e,n){var r=e.getAttributeNode(n);return r&&("id"===n||"name"===n||"coords"===n?""!==r.value:r.specified)?r.value:t},set:function(e,n,r){var i=e.getAttributeNode(r);return i||e.setAttributeNode(i=e.ownerDocument.createAttribute(r)),i.value=n+="","value"===r||n===e.getAttribute(r)?n:t}},b.attrHooks.contenteditable={get:I.get,set:function(e,t,n){I.set(e,""===t?!1:t,n)}},b.each(["width","height"],function(e,n){b.attrHooks[n]=b.extend(b.attrHooks[n],{set:function(e,r){return""===r?(e.setAttribute(n,"auto"),r):t}})})),b.support.hrefNormalized||(b.each(["href","src","width","height"],function(e,n){b.attrHooks[n]=b.extend(b.attrHooks[n],{get:function(e){var r=e.getAttribute(n,2);return null==r?t:r}})}),b.each(["href","src"],function(e,t){b.propHooks[t]={get:function(e){return e.getAttribute(t,4)}}})),b.support.style||(b.attrHooks.style={get:function(e){return e.style.cssText||t},set:function(e,t){return e.style.cssText=t+""}}),b.support.optSelected||(b.propHooks.selected=b.extend(b.propHooks.selected,{get:function(e){var t=e.parentNode;return t&&(t.selectedIndex,t.parentNode&&t.parentNode.selectedIndex),null}})),b.support.enctype||(b.propFix.enctype="encoding"),b.support.checkOn||b.each(["radio","checkbox"],function(){b.valHooks[this]={get:function(e){return null===e.getAttribute("value")?"on":e.value}}}),b.each(["radio","checkbox"],function(){b.valHooks[this]=b.extend(b.valHooks[this],{set:function(e,n){return b.isArray(n)?e.checked=b.inArray(b(e).val(),n)>=0:t}})});var Z=/^(?:input|select|textarea)$/i,et=/^key/,tt=/^(?:mouse|contextmenu)|click/,nt=/^(?:focusinfocus|focusoutblur)$/,rt=/^([^.]*)(?:\.(.+)|)$/;b.event={global:{},add:function(e,n,r,o,a){var s,u,l,c,p,f,d,h,g,m,y,v=b._data(e);if(v){for(r.handler&&(c=r,r=c.handler,a=c.selector),r.guid||(r.guid=b.guid++),(u=v.events)||(u=v.events={}),(f=v.handle)||(f=v.handle=function(e){return typeof b===i||e&&b.event.triggered===e.type?t:b.event.dispatch.apply(f.elem,arguments)},f.elem=e),n=(n||"").match(w)||[""],l=n.length;l--;)s=rt.exec(n[l])||[],g=y=s[1],m=(s[2]||"").split(".").sort(),p=b.event.special[g]||{},g=(a?p.delegateType:p.bindType)||g,p=b.event.special[g]||{},d=b.extend({type:g,origType:y,data:o,handler:r,guid:r.guid,selector:a,needsContext:a&&b.expr.match.needsContext.test(a),namespace:m.join(".")},c),(h=u[g])||(h=u[g]=[],h.delegateCount=0,p.setup&&p.setup.call(e,o,m,f)!==!1||(e.addEventListener?e.addEventListener(g,f,!1):e.attachEvent&&e.attachEvent("on"+g,f))),p.add&&(p.add.call(e,d),d.handler.guid||(d.handler.guid=r.guid)),a?h.splice(h.delegateCount++,0,d):h.push(d),b.event.global[g]=!0;e=null}},remove:function(e,t,n,r,i){var o,a,s,u,l,c,p,f,d,h,g,m=b.hasData(e)&&b._data(e);if(m&&(c=m.events)){for(t=(t||"").match(w)||[""],l=t.length;l--;)if(s=rt.exec(t[l])||[],d=g=s[1],h=(s[2]||"").split(".").sort(),d){for(p=b.event.special[d]||{},d=(r?p.delegateType:p.bindType)||d,f=c[d]||[],s=s[2]&&RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),u=o=f.length;o--;)a=f[o],!i&&g!==a.origType||n&&n.guid!==a.guid||s&&!s.test(a.namespace)||r&&r!==a.selector&&("**"!==r||!a.selector)||(f.splice(o,1),a.selector&&f.delegateCount--,p.remove&&p.remove.call(e,a));u&&!f.length&&(p.teardown&&p.teardown.call(e,h,m.handle)!==!1||b.removeEvent(e,d,m.handle),delete c[d])}else for(d in c)b.event.remove(e,d+t[l],n,r,!0);b.isEmptyObject(c)&&(delete m.handle,b._removeData(e,"events"))}},trigger:function(n,r,i,a){var s,u,l,c,p,f,d,h=[i||o],g=y.call(n,"type")?n.type:n,m=y.call(n,"namespace")?n.namespace.split("."):[];if(l=f=i=i||o,3!==i.nodeType&&8!==i.nodeType&&!nt.test(g+b.event.triggered)&&(g.indexOf(".")>=0&&(m=g.split("."),g=m.shift(),m.sort()),u=0>g.indexOf(":")&&"on"+g,n=n[b.expando]?n:new b.Event(g,"object"==typeof n&&n),n.isTrigger=!0,n.namespace=m.join("."),n.namespace_re=n.namespace?RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,n.result=t,n.target||(n.target=i),r=null==r?[n]:b.makeArray(r,[n]),p=b.event.special[g]||{},a||!p.trigger||p.trigger.apply(i,r)!==!1)){if(!a&&!p.noBubble&&!b.isWindow(i)){for(c=p.delegateType||g,nt.test(c+g)||(l=l.parentNode);l;l=l.parentNode)h.push(l),f=l;f===(i.ownerDocument||o)&&h.push(f.defaultView||f.parentWindow||e)}for(d=0;(l=h[d++])&&!n.isPropagationStopped();)n.type=d>1?c:p.bindType||g,s=(b._data(l,"events")||{})[n.type]&&b._data(l,"handle"),s&&s.apply(l,r),s=u&&l[u],s&&b.acceptData(l)&&s.apply&&s.apply(l,r)===!1&&n.preventDefault();if(n.type=g,!(a||n.isDefaultPrevented()||p._default&&p._default.apply(i.ownerDocument,r)!==!1||"click"===g&&b.nodeName(i,"a")||!b.acceptData(i)||!u||!i[g]||b.isWindow(i))){f=i[u],f&&(i[u]=null),b.event.triggered=g;try{i[g]()}catch(v){}b.event.triggered=t,f&&(i[u]=f)}return n.result}},dispatch:function(e){e=b.event.fix(e);var n,r,i,o,a,s=[],u=h.call(arguments),l=(b._data(this,"events")||{})[e.type]||[],c=b.event.special[e.type]||{};if(u[0]=e,e.delegateTarget=this,!c.preDispatch||c.preDispatch.call(this,e)!==!1){for(s=b.event.handlers.call(this,e,l),n=0;(o=s[n++])&&!e.isPropagationStopped();)for(e.currentTarget=o.elem,a=0;(i=o.handlers[a++])&&!e.isImmediatePropagationStopped();)(!e.namespace_re||e.namespace_re.test(i.namespace))&&(e.handleObj=i,e.data=i.data,r=((b.event.special[i.origType]||{}).handle||i.handler).apply(o.elem,u),r!==t&&(e.result=r)===!1&&(e.preventDefault(),e.stopPropagation()));return c.postDispatch&&c.postDispatch.call(this,e),e.result}},handlers:function(e,n){var r,i,o,a,s=[],u=n.delegateCount,l=e.target;if(u&&l.nodeType&&(!e.button||"click"!==e.type))for(;l!=this;l=l.parentNode||this)if(1===l.nodeType&&(l.disabled!==!0||"click"!==e.type)){for(o=[],a=0;u>a;a++)i=n[a],r=i.selector+" ",o[r]===t&&(o[r]=i.needsContext?b(r,this).index(l)>=0:b.find(r,this,null,[l]).length),o[r]&&o.push(i);o.length&&s.push({elem:l,handlers:o})}return n.length>u&&s.push({elem:this,handlers:n.slice(u)}),s},fix:function(e){if(e[b.expando])return e;var t,n,r,i=e.type,a=e,s=this.fixHooks[i];for(s||(this.fixHooks[i]=s=tt.test(i)?this.mouseHooks:et.test(i)?this.keyHooks:{}),r=s.props?this.props.concat(s.props):this.props,e=new b.Event(a),t=r.length;t--;)n=r[t],e[n]=a[n];return e.target||(e.target=a.srcElement||o),3===e.target.nodeType&&(e.target=e.target.parentNode),e.metaKey=!!e.metaKey,s.filter?s.filter(e,a):e},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:"char charCode key keyCode".split(" "),filter:function(e,t){return null==e.which&&(e.which=null!=t.charCode?t.charCode:t.keyCode),e}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(e,n){var r,i,a,s=n.button,u=n.fromElement;return null==e.pageX&&null!=n.clientX&&(i=e.target.ownerDocument||o,a=i.documentElement,r=i.body,e.pageX=n.clientX+(a&&a.scrollLeft||r&&r.scrollLeft||0)-(a&&a.clientLeft||r&&r.clientLeft||0),e.pageY=n.clientY+(a&&a.scrollTop||r&&r.scrollTop||0)-(a&&a.clientTop||r&&r.clientTop||0)),!e.relatedTarget&&u&&(e.relatedTarget=u===e.target?n.toElement:u),e.which||s===t||(e.which=1&s?1:2&s?3:4&s?2:0),e}},special:{load:{noBubble:!0},click:{trigger:function(){return b.nodeName(this,"input")&&"checkbox"===this.type&&this.click?(this.click(),!1):t}},focus:{trigger:function(){if(this!==o.activeElement&&this.focus)try{return this.focus(),!1}catch(e){}},delegateType:"focusin"},blur:{trigger:function(){return this===o.activeElement&&this.blur?(this.blur(),!1):t},delegateType:"focusout"},beforeunload:{postDispatch:function(e){e.result!==t&&(e.originalEvent.returnValue=e.result)}}},simulate:function(e,t,n,r){var i=b.extend(new b.Event,n,{type:e,isSimulated:!0,originalEvent:{}});r?b.event.trigger(i,null,t):b.event.dispatch.call(t,i),i.isDefaultPrevented()&&n.preventDefault()}},b.removeEvent=o.removeEventListener?function(e,t,n){e.removeEventListener&&e.removeEventListener(t,n,!1)}:function(e,t,n){var r="on"+t;e.detachEvent&&(typeof e[r]===i&&(e[r]=null),e.detachEvent(r,n))},b.Event=function(e,n){return this instanceof b.Event?(e&&e.type?(this.originalEvent=e,this.type=e.type,this.isDefaultPrevented=e.defaultPrevented||e.returnValue===!1||e.getPreventDefault&&e.getPreventDefault()?it:ot):this.type=e,n&&b.extend(this,n),this.timeStamp=e&&e.timeStamp||b.now(),this[b.expando]=!0,t):new b.Event(e,n)},b.Event.prototype={isDefaultPrevented:ot,isPropagationStopped:ot,isImmediatePropagationStopped:ot,preventDefault:function(){var e=this.originalEvent;this.isDefaultPrevented=it,e&&(e.preventDefault?e.preventDefault():e.returnValue=!1)},stopPropagation:function(){var e=this.originalEvent;this.isPropagationStopped=it,e&&(e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=it,this.stopPropagation()}},b.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(e,t){b.event.special[e]={delegateType:t,bindType:t,handle:function(e){var n,r=this,i=e.relatedTarget,o=e.handleObj;return(!i||i!==r&&!b.contains(r,i))&&(e.type=o.origType,n=o.handler.apply(this,arguments),e.type=t),n}}}),b.support.submitBubbles||(b.event.special.submit={setup:function(){return b.nodeName(this,"form")?!1:(b.event.add(this,"click._submit keypress._submit",function(e){var n=e.target,r=b.nodeName(n,"input")||b.nodeName(n,"button")?n.form:t;r&&!b._data(r,"submitBubbles")&&(b.event.add(r,"submit._submit",function(e){e._submit_bubble=!0}),b._data(r,"submitBubbles",!0))}),t)},postDispatch:function(e){e._submit_bubble&&(delete e._submit_bubble,this.parentNode&&!e.isTrigger&&b.event.simulate("submit",this.parentNode,e,!0))},teardown:function(){return b.nodeName(this,"form")?!1:(b.event.remove(this,"._submit"),t)}}),b.support.changeBubbles||(b.event.special.change={setup:function(){return Z.test(this.nodeName)?(("checkbox"===this.type||"radio"===this.type)&&(b.event.add(this,"propertychange._change",function(e){"checked"===e.originalEvent.propertyName&&(this._just_changed=!0)}),b.event.add(this,"click._change",function(e){this._just_changed&&!e.isTrigger&&(this._just_changed=!1),b.event.simulate("change",this,e,!0)})),!1):(b.event.add(this,"beforeactivate._change",function(e){var t=e.target;Z.test(t.nodeName)&&!b._data(t,"changeBubbles")&&(b.event.add(t,"change._change",function(e){!this.parentNode||e.isSimulated||e.isTrigger||b.event.simulate("change",this.parentNode,e,!0)}),b._data(t,"changeBubbles",!0))}),t)},handle:function(e){var n=e.target;return this!==n||e.isSimulated||e.isTrigger||"radio"!==n.type&&"checkbox"!==n.type?e.handleObj.handler.apply(this,arguments):t},teardown:function(){return b.event.remove(this,"._change"),!Z.test(this.nodeName)}}),b.support.focusinBubbles||b.each({focus:"focusin",blur:"focusout"},function(e,t){var n=0,r=function(e){b.event.simulate(t,e.target,b.event.fix(e),!0)};b.event.special[t]={setup:function(){0===n++&&o.addEventListener(e,r,!0)},teardown:function(){0===--n&&o.removeEventListener(e,r,!0)}}}),b.fn.extend({on:function(e,n,r,i,o){var a,s;if("object"==typeof e){"string"!=typeof n&&(r=r||n,n=t);for(a in e)this.on(a,n,r,e[a],o);return this}if(null==r&&null==i?(i=n,r=n=t):null==i&&("string"==typeof n?(i=r,r=t):(i=r,r=n,n=t)),i===!1)i=ot;else if(!i)return this;return 1===o&&(s=i,i=function(e){return b().off(e),s.apply(this,arguments)},i.guid=s.guid||(s.guid=b.guid++)),this.each(function(){b.event.add(this,e,i,r,n)})},one:function(e,t,n,r){return this.on(e,t,n,r,1)},off:function(e,n,r){var i,o;if(e&&e.preventDefault&&e.handleObj)return i=e.handleObj,b(e.delegateTarget).off(i.namespace?i.origType+"."+i.namespace:i.origType,i.selector,i.handler),this;if("object"==typeof e){for(o in e)this.off(o,n,e[o]);return this}return(n===!1||"function"==typeof n)&&(r=n,n=t),r===!1&&(r=ot),this.each(function(){b.event.remove(this,e,r,n)})},bind:function(e,t,n){return this.on(e,null,t,n)},unbind:function(e,t){return this.off(e,null,t)},delegate:function(e,t,n,r){return this.on(t,e,n,r)},undelegate:function(e,t,n){return 1===arguments.length?this.off(e,"**"):this.off(t,e||"**",n)},trigger:function(e,t){return this.each(function(){b.event.trigger(e,t,this)})},triggerHandler:function(e,n){var r=this[0];return r?b.event.trigger(e,n,r,!0):t}}),function(e,t){function rt(e){return Y.test(e+"")}function it(){var e,t=[];return e=function(n,r){return t.push(n+=" ")>i.cacheLength&&delete e[t.shift()],e[n]=r}}function ot(e){return e[x]=!0,e}function at(e){var t=p.createElement("div");try{return e(t)}catch(n){return!1}finally{t=null}}function st(e,t,n,r){var i,o,a,s,u,l,f,g,m,v;if((t?t.ownerDocument||t:w)!==p&&c(t),t=t||p,n=n||[],!e||"string"!=typeof e)return n;if(1!==(s=t.nodeType)&&9!==s)return[];if(!d&&!r){if(i=J.exec(e))if(a=i[1]){if(9===s){if(o=t.getElementById(a),!o||!o.parentNode)return n;if(o.id===a)return n.push(o),n}else if(t.ownerDocument&&(o=t.ownerDocument.getElementById(a))&&y(t,o)&&o.id===a)return n.push(o),n}else{if(i[2])return H.apply(n,q.call(t.getElementsByTagName(e),0)),n;if((a=i[3])&&T.getByClassName&&t.getElementsByClassName)return H.apply(n,q.call(t.getElementsByClassName(a),0)),n}if(T.qsa&&!h.test(e)){if(f=!0,g=x,m=t,v=9===s&&e,1===s&&"object"!==t.nodeName.toLowerCase()){for(l=ft(e),(f=t.getAttribute("id"))?g=f.replace(K,"\\$&"):t.setAttribute("id",g),g="[id='"+g+"'] ",u=l.length;u--;)l[u]=g+dt(l[u]);m=V.test(e)&&t.parentNode||t,v=l.join(",")}if(v)try{return H.apply(n,q.call(m.querySelectorAll(v),0)),n}catch(b){}finally{f||t.removeAttribute("id")}}}return wt(e.replace(W,"$1"),t,n,r)}function ut(e,t){var n=t&&e,r=n&&(~t.sourceIndex||j)-(~e.sourceIndex||j);if(r)return r;if(n)for(;n=n.nextSibling;)if(n===t)return-1;return e?1:-1}function lt(e){return function(t){var n=t.nodeName.toLowerCase();return"input"===n&&t.type===e}}function ct(e){return function(t){var n=t.nodeName.toLowerCase();return("input"===n||"button"===n)&&t.type===e}}function pt(e){return ot(function(t){return t=+t,ot(function(n,r){for(var i,o=e([],n.length,t),a=o.length;a--;)n[i=o[a]]&&(n[i]=!(r[i]=n[i]))})})}function ft(e,t){var n,r,o,a,s,u,l,c=E[e+" "];if(c)return t?0:c.slice(0);for(s=e,u=[],l=i.preFilter;s;){(!n||(r=$.exec(s)))&&(r&&(s=s.slice(r[0].length)||s),u.push(o=[])),n=!1,(r=I.exec(s))&&(n=r.shift(),o.push({value:n,type:r[0].replace(W," ")}),s=s.slice(n.length));for(a in i.filter)!(r=U[a].exec(s))||l[a]&&!(r=l[a](r))||(n=r.shift(),o.push({value:n,type:a,matches:r}),s=s.slice(n.length));if(!n)break}return t?s.length:s?st.error(e):E(e,u).slice(0)}function dt(e){for(var t=0,n=e.length,r="";n>t;t++)r+=e[t].value;return r}function ht(e,t,n){var i=t.dir,o=n&&"parentNode"===i,a=C++;return t.first?function(t,n,r){for(;t=t[i];)if(1===t.nodeType||o)return e(t,n,r)}:function(t,n,s){var u,l,c,p=N+" "+a;if(s){for(;t=t[i];)if((1===t.nodeType||o)&&e(t,n,s))return!0}else for(;t=t[i];)if(1===t.nodeType||o)if(c=t[x]||(t[x]={}),(l=c[i])&&l[0]===p){if((u=l[1])===!0||u===r)return u===!0}else if(l=c[i]=[p],l[1]=e(t,n,s)||r,l[1]===!0)return!0}}function gt(e){return e.length>1?function(t,n,r){for(var i=e.length;i--;)if(!e[i](t,n,r))return!1;return!0}:e[0]}function mt(e,t,n,r,i){for(var o,a=[],s=0,u=e.length,l=null!=t;u>s;s++)(o=e[s])&&(!n||n(o,r,i))&&(a.push(o),l&&t.push(s));return a}function yt(e,t,n,r,i,o){return r&&!r[x]&&(r=yt(r)),i&&!i[x]&&(i=yt(i,o)),ot(function(o,a,s,u){var l,c,p,f=[],d=[],h=a.length,g=o||xt(t||"*",s.nodeType?[s]:s,[]),m=!e||!o&&t?g:mt(g,f,e,s,u),y=n?i||(o?e:h||r)?[]:a:m;if(n&&n(m,y,s,u),r)for(l=mt(y,d),r(l,[],s,u),c=l.length;c--;)(p=l[c])&&(y[d[c]]=!(m[d[c]]=p));if(o){if(i||e){if(i){for(l=[],c=y.length;c--;)(p=y[c])&&l.push(m[c]=p);i(null,y=[],l,u)}for(c=y.length;c--;)(p=y[c])&&(l=i?M.call(o,p):f[c])>-1&&(o[l]=!(a[l]=p))}}else y=mt(y===a?y.splice(h,y.length):y),i?i(null,a,y,u):H.apply(a,y)})}function vt(e){for(var t,n,r,o=e.length,a=i.relative[e[0].type],s=a||i.relative[" "],u=a?1:0,c=ht(function(e){return e===t},s,!0),p=ht(function(e){return M.call(t,e)>-1},s,!0),f=[function(e,n,r){return!a&&(r||n!==l)||((t=n).nodeType?c(e,n,r):p(e,n,r))}];o>u;u++)if(n=i.relative[e[u].type])f=[ht(gt(f),n)];else{if(n=i.filter[e[u].type].apply(null,e[u].matches),n[x]){for(r=++u;o>r&&!i.relative[e[r].type];r++);return yt(u>1&&gt(f),u>1&&dt(e.slice(0,u-1)).replace(W,"$1"),n,r>u&&vt(e.slice(u,r)),o>r&&vt(e=e.slice(r)),o>r&&dt(e))}f.push(n)}return gt(f)}function bt(e,t){var n=0,o=t.length>0,a=e.length>0,s=function(s,u,c,f,d){var h,g,m,y=[],v=0,b="0",x=s&&[],w=null!=d,T=l,C=s||a&&i.find.TAG("*",d&&u.parentNode||u),k=N+=null==T?1:Math.random()||.1;for(w&&(l=u!==p&&u,r=n);null!=(h=C[b]);b++){if(a&&h){for(g=0;m=e[g++];)if(m(h,u,c)){f.push(h);break}w&&(N=k,r=++n)}o&&((h=!m&&h)&&v--,s&&x.push(h))}if(v+=b,o&&b!==v){for(g=0;m=t[g++];)m(x,y,u,c);if(s){if(v>0)for(;b--;)x[b]||y[b]||(y[b]=L.call(f));y=mt(y)}H.apply(f,y),w&&!s&&y.length>0&&v+t.length>1&&st.uniqueSort(f)}return w&&(N=k,l=T),x};return o?ot(s):s}function xt(e,t,n){for(var r=0,i=t.length;i>r;r++)st(e,t[r],n);return n}function wt(e,t,n,r){var o,a,u,l,c,p=ft(e);if(!r&&1===p.length){if(a=p[0]=p[0].slice(0),a.length>2&&"ID"===(u=a[0]).type&&9===t.nodeType&&!d&&i.relative[a[1].type]){if(t=i.find.ID(u.matches[0].replace(et,tt),t)[0],!t)return n;e=e.slice(a.shift().value.length)}for(o=U.needsContext.test(e)?0:a.length;o--&&(u=a[o],!i.relative[l=u.type]);)if((c=i.find[l])&&(r=c(u.matches[0].replace(et,tt),V.test(a[0].type)&&t.parentNode||t))){if(a.splice(o,1),e=r.length&&dt(a),!e)return H.apply(n,q.call(r,0)),n;break}}return s(e,p)(r,t,d,n,V.test(e)),n}function Tt(){}var n,r,i,o,a,s,u,l,c,p,f,d,h,g,m,y,v,x="sizzle"+-new Date,w=e.document,T={},N=0,C=0,k=it(),E=it(),S=it(),A=typeof t,j=1<<31,D=[],L=D.pop,H=D.push,q=D.slice,M=D.indexOf||function(e){for(var t=0,n=this.length;n>t;t++)if(this[t]===e)return t;return-1},_="[\\x20\\t\\r\\n\\f]",F="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",O=F.replace("w","w#"),B="([*^$|!~]?=)",P="\\["+_+"*("+F+")"+_+"*(?:"+B+_+"*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+O+")|)|)"+_+"*\\]",R=":("+F+")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+P.replace(3,8)+")*)|.*)\\)|)",W=RegExp("^"+_+"+|((?:^|[^\\\\])(?:\\\\.)*)"+_+"+$","g"),$=RegExp("^"+_+"*,"+_+"*"),I=RegExp("^"+_+"*([\\x20\\t\\r\\n\\f>+~])"+_+"*"),z=RegExp(R),X=RegExp("^"+O+"$"),U={ID:RegExp("^#("+F+")"),CLASS:RegExp("^\\.("+F+")"),NAME:RegExp("^\\[name=['\"]?("+F+")['\"]?\\]"),TAG:RegExp("^("+F.replace("w","w*")+")"),ATTR:RegExp("^"+P),PSEUDO:RegExp("^"+R),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+_+"*(even|odd|(([+-]|)(\\d*)n|)"+_+"*(?:([+-]|)"+_+"*(\\d+)|))"+_+"*\\)|)","i"),needsContext:RegExp("^"+_+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+_+"*((?:-\\d)?\\d*)"+_+"*\\)|)(?=[^-]|$)","i")},V=/[\x20\t\r\n\f]*[+~]/,Y=/^[^{]+\{\s*\[native code/,J=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,G=/^(?:input|select|textarea|button)$/i,Q=/^h\d$/i,K=/'|\\/g,Z=/\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g,et=/\\([\da-fA-F]{1,6}[\x20\t\r\n\f]?|.)/g,tt=function(e,t){var n="0x"+t-65536;
